...
function seedAddons(db: Database.Database): void {
  try {
    const defaultAddons = [
      ...
      { id: 'mail_ingest', name: 'Mail Ingest', description: 'Auto-import booking emails from your mailbox onto trips', type: 'integration', icon: 'Mail', enabled: 0, sort_order: 16 },
    ];
