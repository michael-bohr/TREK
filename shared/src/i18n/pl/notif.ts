...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.title': 'Rezerwacja zaimportowana',
  'notif.mail_ingest_imported.text': '"{subject}" przypisano do {trip}',
  'notif.mail_ingest_pending.title': 'Rezerwacja wymaga sprawdzenia',
  'notif.mail_ingest_pending.text': 'Nie udało się dopasować "{subject}" do żadnej podróży ({reason})',
