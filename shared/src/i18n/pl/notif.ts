...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.text': '„{subject}” trafiła do {trip}',
  'notif.mail_ingest_pending.title': 'Rezerwacja do sprawdzenia',
  'notif.mail_ingest_pending.text': '„{subject}” nie pasuje do żadnej podróży ({reason})',
