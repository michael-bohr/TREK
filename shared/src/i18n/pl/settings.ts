...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'Import poczty: zaimportowano rezerwację',
  'settings.notifyMailIngestPending': 'Import poczty: rezerwacja wymaga sprawdzenia',
  ...
  'settings.mailIngest.hint':
    'Połącz skrzynkę pocztową, a TREK przeszuka ją w poszukiwaniu potwierdzeń lotów i hoteli, automatycznie przypisując je do właściwej podróży.',
  'settings.mailIngest.host': 'Serwer IMAP',
  'settings.mailIngest.port': 'Port',
  'settings.mailIngest.username': 'Adres e-mail',
  'settings.mailIngest.password': 'Hasło',
  'settings.mailIngest.passwordHint':
    'Większość dostawców wymaga hasła aplikacji zamiast zwykłego hasła — zobacz poniżej.',
  'settings.mailIngest.folder': 'Folder',
  'settings.mailIngest.folderHint': 'Folder IMAP do przeszukania w poszukiwaniu rezerwacji (domyślnie INBOX).',
  'settings.mailIngest.helpTitle': 'Skąd wziąć hasło aplikacji?',
  'settings.mailIngest.helpBody':
    'Większość dostawców blokuje zwykłe logowanie IMAP i wymaga wygenerowanego hasła aplikacji z włączonym dostępem IMAP.',
  'settings.mailIngest.testConnection': 'Testuj połączenie',
  'settings.mailIngest.testing': 'Testowanie…',
  'settings.mailIngest.connect': 'Połącz',
  'settings.mailIngest.connecting': 'Łączenie…',
  'settings.mailIngest.remove': 'Usuń',
  'settings.mailIngest.catchUp': 'Nadrób zaległości',
  'settings.mailIngest.catchUpHint':
    'Przeszukuje ostatnie 30 dni w poszukiwaniu rezerwacji, które TREK mógł przeoczyć.',
  ...
  'settings.mailIngest.activityEmpty': 'Brak aktywności.',
  'settings.mailIngest.noSubject': '(brak tematu)',
  'settings.mailIngest.addedCount': 'Dodano {count}',
  'settings.mailIngest.status.imported': 'Zaimportowano',
  'settings.mailIngest.status.pending': 'Wymaga sprawdzenia',
  ...
  'settings.mailIngest.toast.testFailed': 'Test nieudany: {error}',
  'settings.mailIngest.toast.connected': 'Skrzynka połączona',
  'settings.mailIngest.toast.caughtUp':
    'Zaktualizowano — zaimportowano {imported}, do sprawdzenia {pending}, pominięto {skipped}',
