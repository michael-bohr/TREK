...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'Import poczty: rezerwacja zaimportowana',
  'settings.notifyMailIngestPending': 'Import poczty: rezerwacja do sprawdzenia',
  'settings.mailIngest.title': 'Import poczty',
  'settings.mailIngest.hint':
    'Połącz skrzynkę pocztową, a TREK przeszuka ją pod kątem potwierdzeń lotów i hoteli, przypisując je do właściwej podróży (lub tworząc nową). Odczytuje Twoją skrzynkę odbiorczą — poniżej możesz wskazać folder, np. dedykowany folder TREK.',
  'settings.mailIngest.host': 'Host IMAP',
  'settings.mailIngest.port': 'Port',
  'settings.mailIngest.username': 'Nazwa użytkownika',
  'settings.mailIngest.password': 'Hasło (hasło aplikacji)',
  'settings.mailIngest.passwordHint': 'Użyj hasła aplikacji, a nie hasła logowania.',
  'settings.mailIngest.folder': 'Folder',
  'settings.mailIngest.folderHint':
    'Domyślnie INBOX. Wskaż dedykowany folder, aby TREK nie czytał reszty Twojej poczty.',
  'settings.mailIngest.helpTitle': 'Gdzie utworzyć hasło aplikacji?',
  'settings.mailIngest.helpBody':
    'Większość dostawców blokuje zwykłe logowanie IMAP — wygeneruj hasło aplikacji, upewnij się, że IMAP jest włączony w ustawieniach poczty, i wklej je powyżej.',
  'settings.mailIngest.testConnection': 'Testuj połączenie',
  'settings.mailIngest.testing': 'Testowanie…',
  'settings.mailIngest.connect': 'Połącz skrzynkę',
  'settings.mailIngest.connecting': 'Łączenie…',
  'settings.mailIngest.lastChecked': 'ostatnio sprawdzono {time}',
  'settings.mailIngest.notCheckedYet': 'jeszcze nie sprawdzono',
  'settings.mailIngest.catchUp': 'Nadrób',
  'settings.mailIngest.catchUpHint': 'Przeskanuj teraz ostatnie 30 dni',
  'settings.mailIngest.remove': 'Usuń',
  'settings.mailIngest.recentActivity': 'Ostatnia aktywność',
  'settings.mailIngest.activityEmpty':
    'Jeszcze nic nie przetworzono — uruchom nadrabianie lub poczekaj na kolejne zaplanowane sprawdzenie.',
  'settings.mailIngest.noSubject': '(brak tematu)',
  'settings.mailIngest.addedCount': '({count} dodano)',
  'settings.mailIngest.status.imported': 'zaimportowano',
  'settings.mailIngest.status.pending': 'oczekuje',
  'settings.mailIngest.status.error': 'błąd',
  'settings.mailIngest.status.skipped': 'pominięto',
  'settings.mailIngest.toast.testOk': 'Połączenie udane',
  'settings.mailIngest.toast.testFailed': 'Połączenie nieudane: {error}',
  'settings.mailIngest.toast.connected': 'Skrzynka połączona',
  'settings.mailIngest.toast.caughtUp': 'Gotowe — {imported} dodano, {pending} do sprawdzenia, {skipped} pominięto',
