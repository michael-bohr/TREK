...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.title': 'Rezervace importována',
  'notif.mail_ingest_imported.text': '"{subject}" byla přiřazena k {trip}',
  'notif.mail_ingest_pending.title': 'Rezervace vyžaduje kontrolu',
  'notif.mail_ingest_pending.text': '"{subject}" se nepodařilo přiřadit k žádné cestě ({reason})',
