...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'Import e-mailů: rezervace importována',
  'settings.notifyMailIngestPending': 'Import e-mailů: rezervace ke kontrole',
  'settings.mailIngest.title': 'Import e-mailů',
  'settings.mailIngest.hint':
    'Připojte poštovní schránku a TREK v ní vyhledá potvrzení letů a hotelů a zařadí je k odpovídající cestě (případně ji vytvoří). Prohledává vaši doručenou poštu — níže můžete nastavit složku, např. vyhrazenou složku TREK.',
  'settings.mailIngest.host': 'IMAP server',
  'settings.mailIngest.port': 'Port',
  'settings.mailIngest.username': 'Uživatelské jméno',
  'settings.mailIngest.password': 'Heslo (aplikační heslo)',
  'settings.mailIngest.passwordHint': 'Použijte aplikační heslo, ne své přihlašovací heslo.',
  'settings.mailIngest.folder': 'Složka',
  'settings.mailIngest.folderHint': 'Výchozí je INBOX. Zvolte vyhrazenou složku, aby TREK nečetl zbytek vaší pošty.',
  'settings.mailIngest.helpTitle': 'Kde vytvořím aplikační heslo?',
  'settings.mailIngest.helpBody':
    'Většina poskytovatelů blokuje prosté přihlášení přes IMAP — vytvořte aplikační heslo, ověřte, že je IMAP v nastavení pošty povolen, a vložte ho výše.',
  'settings.mailIngest.testConnection': 'Otestovat připojení',
  'settings.mailIngest.testing': 'Testuji…',
  'settings.mailIngest.connect': 'Připojit schránku',
  'settings.mailIngest.connecting': 'Připojuji…',
  'settings.mailIngest.lastChecked': 'naposledy zkontrolováno {time}',
  'settings.mailIngest.notCheckedYet': 'zatím nekontrolováno',
  'settings.mailIngest.catchUp': 'Dohnat',
  'settings.mailIngest.catchUpHint': 'Prohledat posledních 30 dní',
  'settings.mailIngest.remove': 'Odebrat',
  'settings.mailIngest.recentActivity': 'Nedávná aktivita',
  'settings.mailIngest.activityEmpty':
    'Zatím nic nezpracováno — spusťte dohnání nebo počkejte na další naplánovanou kontrolu.',
  'settings.mailIngest.noSubject': '(bez předmětu)',
  'settings.mailIngest.addedCount': '({count} přidáno)',
  'settings.mailIngest.status.imported': 'importováno',
  'settings.mailIngest.status.pending': 'čeká',
  'settings.mailIngest.status.error': 'chyba',
  'settings.mailIngest.status.skipped': 'přeskočeno',
  'settings.mailIngest.toast.testOk': 'Připojení úspěšné',
  'settings.mailIngest.toast.testFailed': 'Připojení selhalo: {error}',
  'settings.mailIngest.toast.connected': 'Schránka připojena',
  'settings.mailIngest.toast.caughtUp': 'Hotovo — {imported} přidáno, {pending} ke kontrole, {skipped} přeskočeno',
