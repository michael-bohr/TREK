...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'Import pošty: rezervace importována',
  'settings.notifyMailIngestPending': 'Import pošty: rezervace vyžaduje kontrolu',
  ...
  'settings.mailIngest.title': 'Import pošty',
  'settings.mailIngest.hint':
    'Připojte schránku a TREK ji prohledá na potvrzení letů a hotelů, které automaticky zařadí do správné cesty.',
  'settings.mailIngest.host': 'IMAP server',
  'settings.mailIngest.port': 'Port',
  'settings.mailIngest.username': 'E-mailová adresa',
  'settings.mailIngest.password': 'Heslo',
  'settings.mailIngest.passwordHint': 'Většina poskytovatelů vyžaduje místo běžného hesla heslo aplikace — viz níže.',
  'settings.mailIngest.folder': 'Složka',
  'settings.mailIngest.folderHint': 'Složka IMAP, která se má prohledávat (výchozí INBOX).',
  'settings.mailIngest.helpTitle': 'Kde získám heslo aplikace?',
  'settings.mailIngest.helpBody':
    'Většina poskytovatelů blokuje běžné přihlášení IMAP a vyžaduje vygenerované heslo aplikace s povoleným přístupem IMAP.',
  'settings.mailIngest.testConnection': 'Otestovat připojení',
  'settings.mailIngest.testing': 'Testování…',
  'settings.mailIngest.connect': 'Připojit',
  'settings.mailIngest.connecting': 'Připojování…',
  'settings.mailIngest.remove': 'Odebrat',
  'settings.mailIngest.catchUp': 'Doplnit',
  'settings.mailIngest.catchUpHint': 'Prohledá posledních 30 dní kvůli rezervacím, které TREK mohl přehlédnout.',
  'settings.mailIngest.lastChecked': 'Naposledy zkontrolováno {time}',
  'settings.mailIngest.notCheckedYet': 'Zatím nezkontrolováno',
  'settings.mailIngest.recentActivity': 'Nedávná aktivita',
  'settings.mailIngest.activityEmpty': 'Zatím žádná aktivita.',
  'settings.mailIngest.noSubject': '(bez předmětu)',
  'settings.mailIngest.addedCount': 'Přidáno {count}',
  'settings.mailIngest.status.imported': 'Importováno',
  'settings.mailIngest.status.pending': 'Vyžaduje kontrolu',
  ...
  'settings.mailIngest.toast.testFailed': 'Test se nezdařil: {error}',
  'settings.mailIngest.toast.connected': 'Schránka připojena',
  'settings.mailIngest.toast.caughtUp':
    'Doplněno — importováno {imported}, ke kontrole {pending}, přeskočeno {skipped}',
