...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'Εισαγωγή αλληλογραφίας: έγινε εισαγωγή κράτησης',
  'settings.notifyMailIngestPending': 'Εισαγωγή αλληλογραφίας: κράτηση απαιτεί έλεγχο',
  ...
  'settings.mailIngest.title': 'Εισαγωγή αλληλογραφίας',
  'settings.mailIngest.hint':
    'Συνδέστε ένα γραμματοκιβώτιο και το TREK το σαρώνει για επιβεβαιώσεις πτήσεων και ξενοδοχείων, καταχωρώντας τις αυτόματα στο σωστό ταξίδι.',
  'settings.mailIngest.host': 'Διακομιστής IMAP',
  'settings.mailIngest.port': 'Θύρα',
  'settings.mailIngest.username': 'Διεύθυνση email',
  'settings.mailIngest.password': 'Κωδικός πρόσβασης',
  'settings.mailIngest.passwordHint':
    'Οι περισσότεροι πάροχοι απαιτούν κωδικό εφαρμογής αντί για τον κανονικό σας κωδικό — δείτε παρακάτω.',
  'settings.mailIngest.folder': 'Φάκελος',
  'settings.mailIngest.folderHint': 'Φάκελος IMAP προς σάρωση για κρατήσεις (προεπιλογή INBOX).',
  'settings.mailIngest.helpTitle': 'Πού βρίσκω κωδικό εφαρμογής;',
  'settings.mailIngest.helpBody':
    'Οι περισσότεροι πάροχοι μπλοκάρουν τις απλές συνδέσεις IMAP και απαιτούν έναν κωδικό εφαρμογής με ενεργοποιημένη πρόσβαση IMAP.',
  'settings.mailIngest.testConnection': 'Δοκιμή σύνδεσης',
  'settings.mailIngest.testing': 'Δοκιμή…',
  'settings.mailIngest.connect': 'Σύνδεση',
  'settings.mailIngest.connecting': 'Σύνδεση σε εξέλιξη…',
  'settings.mailIngest.remove': 'Αφαίρεση',
  'settings.mailIngest.catchUp': 'Ενημέρωση',
  'settings.mailIngest.catchUpHint':
    'Σαρώνει τις τελευταίες 30 ημέρες για κρατήσεις που το TREK ενδέχεται να παρέλειψε.',
  'settings.mailIngest.lastChecked': 'Τελευταίος έλεγχος {time}',
  'settings.mailIngest.notCheckedYet': 'Δεν έχει ελεγχθεί ακόμα',
  'settings.mailIngest.recentActivity': 'Πρόσφατη δραστηριότητα',
  'settings.mailIngest.activityEmpty': 'Καμία δραστηριότητα ακόμα.',
  'settings.mailIngest.noSubject': '(χωρίς θέμα)',
  'settings.mailIngest.addedCount': '{count} προστέθηκαν',
  'settings.mailIngest.status.imported': 'Έγινε εισαγωγή',
  'settings.mailIngest.status.pending': 'Απαιτεί έλεγχο',
  ...
  'settings.mailIngest.toast.testFailed': 'Η δοκιμή απέτυχε: {error}',
  'settings.mailIngest.toast.connected': 'Το γραμματοκιβώτιο συνδέθηκε',
  'settings.mailIngest.toast.caughtUp':
    'Ολοκληρώθηκε — {imported} έγιναν εισαγωγή, {pending} προς έλεγχο, {skipped} παραλείφθηκαν',
