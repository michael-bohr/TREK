...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'Εισαγωγή email: η κράτηση εισήχθη',
  'settings.notifyMailIngestPending': 'Εισαγωγή email: κράτηση προς έλεγχο',
  'settings.mailIngest.title': 'Εισαγωγή email',
  'settings.mailIngest.hint':
    'Συνδέστε ένα γραμματοκιβώτιο και το TREK το σαρώνει για επιβεβαιώσεις πτήσεων και ξενοδοχείων, αρχειοθετώντας τες στο αντίστοιχο ταξίδι (δημιουργώντας το αν δεν υπάρχει). Διαβάζει τα εισερχόμενά σας — ορίστε παρακάτω έναν φάκελο για περιορισμό, π.χ. έναν ειδικό φάκελο TREK.',
  'settings.mailIngest.host': 'Διακομιστής IMAP',
  'settings.mailIngest.port': 'Θύρα',
  'settings.mailIngest.username': 'Όνομα χρήστη',
  'settings.mailIngest.password': 'Κωδικός (κωδικός εφαρμογής)',
  'settings.mailIngest.passwordHint': 'Χρησιμοποιήστε κωδικό εφαρμογής, όχι τον κωδικό σύνδεσής σας.',
  'settings.mailIngest.folder': 'Φάκελος',
  'settings.mailIngest.folderHint':
    'Προεπιλογή INBOX. Ορίστε ειδικό φάκελο ώστε το TREK να μην έχει πρόσβαση στην υπόλοιπη αλληλογραφία σας.',
  'settings.mailIngest.helpTitle': 'Πού δημιουργώ κωδικό εφαρμογής;',
  'settings.mailIngest.helpBody':
    'Οι περισσότεροι πάροχοι μπλοκάρουν τις απλές συνδέσεις IMAP — δημιουργήστε κωδικό εφαρμογής, βεβαιωθείτε ότι το IMAP είναι ενεργό στις ρυθμίσεις email και επικολλήστε τον παραπάνω.',
  'settings.mailIngest.testConnection': 'Δοκιμή σύνδεσης',
  'settings.mailIngest.testing': 'Δοκιμή…',
  'settings.mailIngest.connect': 'Σύνδεση γραμματοκιβωτίου',
  'settings.mailIngest.connecting': 'Σύνδεση…',
  'settings.mailIngest.lastChecked': 'τελευταίος έλεγχος {time}',
  'settings.mailIngest.notCheckedYet': 'δεν έχει ελεγχθεί ακόμη',
  'settings.mailIngest.catchUp': 'Ενημέρωση',
  'settings.mailIngest.catchUpHint': 'Σάρωση των τελευταίων 30 ημερών τώρα',
  'settings.mailIngest.remove': 'Αφαίρεση',
  'settings.mailIngest.recentActivity': 'Πρόσφατη δραστηριότητα',
  'settings.mailIngest.activityEmpty':
    'Δεν έχει γίνει καμία επεξεργασία — εκτελέστε ενημέρωση ή περιμένετε τον επόμενο προγραμματισμένο έλεγχο.',
  'settings.mailIngest.noSubject': '(χωρίς θέμα)',
  'settings.mailIngest.addedCount': '({count} προστέθηκαν)',
  'settings.mailIngest.status.imported': 'εισήχθη',
  'settings.mailIngest.status.pending': 'σε εκκρεμότητα',
  'settings.mailIngest.status.error': 'σφάλμα',
  'settings.mailIngest.status.skipped': 'παραλείφθηκε',
  'settings.mailIngest.toast.testOk': 'Επιτυχής σύνδεση',
  'settings.mailIngest.toast.testFailed': 'Αποτυχία σύνδεσης: {error}',
  'settings.mailIngest.toast.connected': 'Το γραμματοκιβώτιο συνδέθηκε',
  'settings.mailIngest.toast.caughtUp':
    'Ολοκληρώθηκε — {imported} προστέθηκαν, {pending} προς έλεγχο, {skipped} παραλείφθηκαν',
