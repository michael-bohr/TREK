...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.title': 'Έγινε εισαγωγή κράτησης',
  'notif.mail_ingest_imported.text': 'Το "{subject}" καταχωρήθηκε στο {trip}',
  'notif.mail_ingest_pending.title': 'Κράτηση απαιτεί έλεγχο',
  'notif.mail_ingest_pending.text': 'Το "{subject}" δεν μπόρεσε να αντιστοιχιστεί σε ταξίδι ({reason})',
