...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.title': 'Η κράτηση εισήχθη',
  'notif.mail_ingest_imported.text': 'Το «{subject}» αρχειοθετήθηκε στο {trip}',
  'notif.mail_ingest_pending.title': 'Κράτηση προς έλεγχο',
  'notif.mail_ingest_pending.text': 'Το «{subject}» δεν αντιστοιχήθηκε σε ταξίδι ({reason})',
