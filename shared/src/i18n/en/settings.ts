...
const settings: TranslationStrings = {
  ...
  'settings.mailIngest.hint':
    'Connect a mailbox and TREK scans it for flight and hotel confirmations, filing them onto the right trip automatically.',
  'settings.mailIngest.host': 'IMAP server',
  'settings.mailIngest.port': 'Port',
  'settings.mailIngest.username': 'Email address',
  'settings.mailIngest.password': 'Password',
  'settings.mailIngest.passwordHint':
    'Most providers require an app password instead of your regular password — see below.',
  'settings.mailIngest.folder': 'Folder',
  'settings.mailIngest.folderHint': 'IMAP folder to scan for bookings (defaults to INBOX).',
  'settings.mailIngest.helpTitle': 'Where do I get an app password?',
  'settings.mailIngest.helpBody':
    'Most providers block plain IMAP logins and require a generated app password with IMAP access enabled.',
  'settings.mailIngest.testConnection': 'Test connection',
  'settings.mailIngest.testing': 'Testing…',
  'settings.mailIngest.connect': 'Connect',
  'settings.mailIngest.connecting': 'Connecting…',
  'settings.mailIngest.remove': 'Remove',
  'settings.mailIngest.catchUp': 'Catch up',
  'settings.mailIngest.catchUpHint': 'Scan the last 30 days for bookings TREK may have missed.',
  ...
  'settings.mailIngest.activityEmpty': 'No activity yet.',
  ...
  'settings.mailIngest.status.pending': 'Needs review',
  ...
  'settings.mailIngest.toast.testFailed': 'Test failed: {error}',
  'settings.mailIngest.toast.connected': 'Mailbox connected',
  'settings.mailIngest.toast.caughtUp': 'Caught up — {imported} imported, {pending} pending, {skipped} skipped',
