...
const settings: TranslationStrings = {
  ...
  'settings.mailIngest.title': 'Mail ingest',
  'settings.mailIngest.hint':
    'Connect a mailbox and TREK scans it for flight & hotel confirmations, filing each onto the matching trip (creating the trip if none exists). It reads your inbox to find bookings — set a folder below to limit it to, e.g., a dedicated TREK folder.',
  'settings.mailIngest.host': 'IMAP host',
  'settings.mailIngest.port': 'Port',
  'settings.mailIngest.username': 'Username',
  'settings.mailIngest.password': 'Password (app password)',
  'settings.mailIngest.passwordHint': 'Use an app password, not your login password.',
  'settings.mailIngest.folder': 'Folder',
  'settings.mailIngest.folderHint': 'Default INBOX. Point at a dedicated folder to keep TREK out of the rest of your mail.',
  'settings.mailIngest.helpTitle': 'Where do I create an app password?',
  'settings.mailIngest.helpBody':
    'Most providers block plain IMAP logins — generate an app password and make sure IMAP is enabled in your mail settings, then paste it above.',
  'settings.mailIngest.testConnection': 'Test connection',
  'settings.mailIngest.testing': 'Testing…',
  'settings.mailIngest.connect': 'Connect mailbox',
  'settings.mailIngest.connecting': 'Connecting…',
  'settings.mailIngest.lastChecked': 'last checked {time}',
  'settings.mailIngest.notCheckedYet': 'not checked yet',
  'settings.mailIngest.catchUp': 'Catch up',
  'settings.mailIngest.catchUpHint': 'Scan the last 30 days now',
  'settings.mailIngest.remove': 'Remove',
  'settings.mailIngest.recentActivity': 'Recent activity',
  'settings.mailIngest.activityEmpty': 'Nothing processed yet — run a catch-up or wait for the next scheduled check.',
  'settings.mailIngest.noSubject': '(no subject)',
  'settings.mailIngest.addedCount': '({count} added)',
  'settings.mailIngest.status.imported': 'imported',
  'settings.mailIngest.status.pending': 'pending',
  'settings.mailIngest.status.error': 'error',
  'settings.mailIngest.status.skipped': 'skipped',
  'settings.mailIngest.toast.testOk': 'Connection successful',
  'settings.mailIngest.toast.testFailed': 'Connection failed: {error}',
  'settings.mailIngest.toast.connected': 'Mailbox connected',
  'settings.mailIngest.toast.caughtUp': 'Caught up — {imported} added, {pending} to review, {skipped} skipped',
