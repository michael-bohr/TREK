...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.title': 'Booking imported',
  'notif.mail_ingest_imported.text': '"{subject}" was filed to {trip}',
  'notif.mail_ingest_pending.title': 'Booking needs review',
  'notif.mail_ingest_pending.text': '"{subject}" couldn\'t be matched to a trip ({reason})',
