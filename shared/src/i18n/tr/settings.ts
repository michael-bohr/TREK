...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'E-posta alımı: rezervasyon içe aktarıldı',
  'settings.notifyMailIngestPending': 'E-posta alımı: incelenecek rezervasyon',
  'settings.mailIngest.title': 'E-posta alımı',
  'settings.mailIngest.hint':
    'Bir posta kutusu bağlayın; TREK uçuş ve otel onaylarını tarar ve her birini uygun geziye ekler (gezi yoksa oluşturur). Gelen kutunuz okunur — aşağıda bir klasör belirterek örneğin özel bir TREK klasörüyle sınırlayabilirsiniz.',
  'settings.mailIngest.host': 'IMAP sunucusu',
  'settings.mailIngest.port': 'Bağlantı noktası',
  'settings.mailIngest.username': 'Kullanıcı adı',
  'settings.mailIngest.password': 'Parola (uygulama parolası)',
  'settings.mailIngest.passwordHint': 'Giriş parolanızı değil, uygulama parolası kullanın.',
  'settings.mailIngest.folder': 'Klasör',
  'settings.mailIngest.folderHint':
    'Varsayılan INBOX. TREK\'in diğer e-postalarınıza erişmemesi için özel bir klasör seçin.',
  'settings.mailIngest.helpTitle': 'Uygulama parolasını nerede oluşturabilirim?',
  'settings.mailIngest.helpBody':
    'Çoğu sağlayıcı düz IMAP girişini engeller — bir uygulama parolası oluşturun, posta ayarlarınızda IMAP\'ın etkin olduğundan emin olun ve yukarıya yapıştırın.',
  'settings.mailIngest.testConnection': 'Bağlantıyı test et',
  'settings.mailIngest.testing': 'Test ediliyor…',
  'settings.mailIngest.connect': 'Posta kutusunu bağla',
  'settings.mailIngest.connecting': 'Bağlanıyor…',
  'settings.mailIngest.lastChecked': 'son kontrol {time}',
  'settings.mailIngest.notCheckedYet': 'henüz kontrol edilmedi',
  'settings.mailIngest.catchUp': 'Yetiş',
  'settings.mailIngest.catchUpHint': 'Son 30 günü şimdi tara',
  'settings.mailIngest.remove': 'Kaldır',
  'settings.mailIngest.recentActivity': 'Son etkinlik',
  'settings.mailIngest.activityEmpty':
    'Henüz bir şey işlenmedi — yetişme çalıştırın veya bir sonraki planlı kontrolü bekleyin.',
  'settings.mailIngest.noSubject': '(konu yok)',
  'settings.mailIngest.addedCount': '({count} eklendi)',
  'settings.mailIngest.status.imported': 'içe aktarıldı',
  'settings.mailIngest.status.pending': 'beklemede',
  'settings.mailIngest.status.error': 'hata',
  'settings.mailIngest.status.skipped': 'atlandı',
  'settings.mailIngest.toast.testOk': 'Bağlantı başarılı',
  'settings.mailIngest.toast.testFailed': 'Bağlantı başarısız: {error}',
  'settings.mailIngest.toast.connected': 'Posta kutusu bağlandı',
  'settings.mailIngest.toast.caughtUp': 'Tamamlandı — {imported} eklendi, {pending} incelenecek, {skipped} atlandı',
