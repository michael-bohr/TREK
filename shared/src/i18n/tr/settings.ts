...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'Posta içe aktarma: rezervasyon içe aktarıldı',
  'settings.notifyMailIngestPending': 'Posta içe aktarma: rezervasyon inceleme gerektiriyor',
  ...
  'settings.mailIngest.title': 'Posta içe aktarma',
  'settings.mailIngest.hint':
    'Bir posta kutusu bağlayın; TREK uçuş ve otel onaylarını tarayıp otomatik olarak doğru seyahate ekler.',
  'settings.mailIngest.host': 'IMAP sunucusu',
  'settings.mailIngest.port': 'Port',
  'settings.mailIngest.username': 'E-posta adresi',
  'settings.mailIngest.password': 'Şifre',
  'settings.mailIngest.passwordHint':
    'Çoğu sağlayıcı normal şifreniz yerine bir uygulama şifresi ister — aşağıya bakın.',
  'settings.mailIngest.folder': 'Klasör',
  'settings.mailIngest.folderHint': 'Taranacak IMAP klasörü (varsayılan INBOX).',
  'settings.mailIngest.helpTitle': 'Uygulama şifresini nereden alırım?',
  'settings.mailIngest.helpBody':
    'Çoğu sağlayıcı düz IMAP girişlerini engeller ve IMAP erişimi etkinleştirilmiş, oluşturulmuş bir uygulama şifresi ister.',
  'settings.mailIngest.testConnection': 'Bağlantıyı test et',
  'settings.mailIngest.testing': 'Test ediliyor…',
  'settings.mailIngest.connect': 'Bağlan',
  'settings.mailIngest.connecting': 'Bağlanıyor…',
  'settings.mailIngest.remove': 'Kaldır',
  'settings.mailIngest.catchUp': 'Geriye dönük tara',
  'settings.mailIngest.catchUpHint': "TREK'in kaçırmış olabileceği rezervasyonlar için son 30 günü tarar.",
  ...
  'settings.mailIngest.activityEmpty': 'Henüz etkinlik yok.',
  'settings.mailIngest.noSubject': '(konu yok)',
  'settings.mailIngest.addedCount': '{count} eklendi',
  'settings.mailIngest.status.imported': 'İçe aktarıldı',
  'settings.mailIngest.status.pending': 'İnceleme gerekiyor',
  ...
  'settings.mailIngest.toast.testFailed': 'Test başarısız: {error}',
  'settings.mailIngest.toast.connected': 'Posta kutusu bağlandı',
  'settings.mailIngest.toast.caughtUp':
    'Tamamlandı — {imported} içe aktarıldı, {pending} incelemede, {skipped} atlandı',
