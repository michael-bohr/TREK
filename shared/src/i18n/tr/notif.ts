...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.text': '"{subject}" {trip} gezisine eklendi',
  'notif.mail_ingest_pending.title': 'İncelenecek rezervasyon',
  'notif.mail_ingest_pending.text': '"{subject}" hiçbir geziyle eşleştirilemedi ({reason})',
