...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.title': 'Rezervasyon içe aktarıldı',
  'notif.mail_ingest_imported.text': '"{subject}" {trip} seyahatine kaydedildi',
  'notif.mail_ingest_pending.title': 'Rezervasyon inceleme gerektiriyor',
  'notif.mail_ingest_pending.text': '"{subject}" bir seyahatle eşleştirilemedi ({reason})',
