...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'Importazione email: prenotazione importata',
  'settings.notifyMailIngestPending': 'Importazione email: prenotazione da rivedere',
  'settings.mailIngest.title': 'Importazione email',
  'settings.mailIngest.hint':
    'Collega una casella di posta e TREK la analizza in cerca di conferme di voli e hotel, archiviandole nel viaggio corrispondente (creandolo se non esiste). Legge la tua posta in arrivo — imposta una cartella qui sotto per limitarla, ad es. una cartella TREK dedicata.',
  'settings.mailIngest.host': 'Host IMAP',
  'settings.mailIngest.port': 'Porta',
  'settings.mailIngest.username': 'Nome utente',
  'settings.mailIngest.password': 'Password (password per app)',
  'settings.mailIngest.passwordHint': 'Usa una password per app, non la tua password di accesso.',
  'settings.mailIngest.folder': 'Cartella',
  'settings.mailIngest.folderHint':
    'Predefinita INBOX. Scegli una cartella dedicata per tenere TREK fuori dal resto della tua posta.',
  'settings.mailIngest.helpTitle': 'Dove creo una password per app?',
  'settings.mailIngest.helpBody':
    'La maggior parte dei provider blocca gli accessi IMAP semplici — genera una password per app, verifica che IMAP sia attivo nelle impostazioni della posta e incollala sopra.',
  'settings.mailIngest.testConnection': 'Prova connessione',
  'settings.mailIngest.testing': 'Prova in corso…',
  'settings.mailIngest.connect': 'Collega casella',
  'settings.mailIngest.connecting': 'Collegamento…',
  'settings.mailIngest.lastChecked': 'ultimo controllo {time}',
  'settings.mailIngest.notCheckedYet': 'non ancora controllata',
  'settings.mailIngest.catchUp': 'Recupera',
  'settings.mailIngest.catchUpHint': 'Analizza ora gli ultimi 30 giorni',
  'settings.mailIngest.remove': 'Rimuovi',
  'settings.mailIngest.recentActivity': 'Attività recente',
  'settings.mailIngest.activityEmpty':
    'Ancora nulla di elaborato — avvia un recupero o attendi il prossimo controllo pianificato.',
  'settings.mailIngest.noSubject': '(senza oggetto)',
  'settings.mailIngest.addedCount': '({count} aggiunte)',
  'settings.mailIngest.status.imported': 'importata',
  'settings.mailIngest.status.pending': 'in attesa',
  'settings.mailIngest.status.error': 'errore',
  'settings.mailIngest.status.skipped': 'saltata',
  'settings.mailIngest.toast.testOk': 'Connessione riuscita',
  'settings.mailIngest.toast.testFailed': 'Connessione non riuscita: {error}',
  'settings.mailIngest.toast.connected': 'Casella collegata',
  'settings.mailIngest.toast.caughtUp':
    'Recupero completato — {imported} aggiunte, {pending} da rivedere, {skipped} saltate',
