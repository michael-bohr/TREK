...
const settings: TranslationStrings = {
  ...
  'settings.mailIngest.hint':
    'Collega una casella di posta e TREK la analizza alla ricerca di conferme di volo e hotel, archiviandole automaticamente nel viaggio corretto.',
  'settings.mailIngest.host': 'Server IMAP',
  'settings.mailIngest.port': 'Porta',
  'settings.mailIngest.username': 'Indirizzo email',
  'settings.mailIngest.password': 'Password',
  'settings.mailIngest.passwordHint':
    'La maggior parte dei provider richiede una password per app al posto della tua password normale — vedi sotto.',
  'settings.mailIngest.folder': 'Cartella',
  'settings.mailIngest.folderHint': 'Cartella IMAP da analizzare per le prenotazioni (INBOX predefinita).',
  'settings.mailIngest.helpTitle': 'Dove ottengo una password per app?',
  'settings.mailIngest.helpBody':
    "La maggior parte dei provider blocca gli accessi IMAP standard e richiede una password per app generata con l'accesso IMAP abilitato.",
  'settings.mailIngest.testConnection': 'Prova connessione',
  'settings.mailIngest.testing': 'Verifica in corso…',
  'settings.mailIngest.connect': 'Connetti',
  'settings.mailIngest.connecting': 'Connessione…',
  'settings.mailIngest.remove': 'Rimuovi',
  'settings.mailIngest.catchUp': 'Recupera',
  'settings.mailIngest.catchUpHint':
    'Analizza gli ultimi 30 giorni alla ricerca di prenotazioni che TREK potrebbe aver perso.',
  'settings.mailIngest.lastChecked': 'Ultimo controllo {time}',
  'settings.mailIngest.notCheckedYet': 'Non ancora controllato',
  'settings.mailIngest.recentActivity': 'Attività recente',
  'settings.mailIngest.activityEmpty': 'Nessuna attività per ora.',
  'settings.mailIngest.noSubject': '(nessun oggetto)',
  'settings.mailIngest.addedCount': '{count} aggiunta/e',
  'settings.mailIngest.status.imported': 'Importata',
  'settings.mailIngest.status.pending': 'Da rivedere',
  ...
  'settings.mailIngest.toast.testFailed': 'Test non riuscito: {error}',
  'settings.mailIngest.toast.connected': 'Casella di posta connessa',
  'settings.mailIngest.toast.caughtUp':
    'Recupero completato — {imported} importate, {pending} da rivedere, {skipped} saltate',
