...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.title': 'Prenotazione importata',
  'notif.mail_ingest_imported.text': '"{subject}" è stata archiviata in {trip}',
  'notif.mail_ingest_pending.title': 'Prenotazione da rivedere',
  'notif.mail_ingest_pending.text': 'Non è stato possibile abbinare "{subject}" a un viaggio ({reason})',
