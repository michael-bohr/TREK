...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestPending': 'Nhập email: đặt chỗ cần xem xét',
  ...
  'settings.mailIngest.hint':
    'Kết nối một hộp thư để TREK quét tìm xác nhận chuyến bay và khách sạn, tự động xếp vào đúng chuyến đi.',
  'settings.mailIngest.host': 'Máy chủ IMAP',
  'settings.mailIngest.port': 'Cổng',
  'settings.mailIngest.username': 'Địa chỉ email',
  'settings.mailIngest.password': 'Mật khẩu',
  'settings.mailIngest.passwordHint':
    'Hầu hết nhà cung cấp yêu cầu mật khẩu ứng dụng thay vì mật khẩu thông thường — xem bên dưới.',
  'settings.mailIngest.folder': 'Thư mục',
  'settings.mailIngest.folderHint': 'Thư mục IMAP cần quét để tìm đặt chỗ (mặc định là INBOX).',
  'settings.mailIngest.helpTitle': 'Lấy mật khẩu ứng dụng ở đâu?',
  'settings.mailIngest.helpBody':
    'Hầu hết nhà cung cấp chặn đăng nhập IMAP thông thường và yêu cầu mật khẩu ứng dụng được tạo với quyền truy cập IMAP đã bật.',
  'settings.mailIngest.testConnection': 'Kiểm tra kết nối',
  'settings.mailIngest.testing': 'Đang kiểm tra…',
  'settings.mailIngest.connect': 'Kết nối',
  'settings.mailIngest.connecting': 'Đang kết nối…',
  'settings.mailIngest.remove': 'Xóa',
  'settings.mailIngest.catchUp': 'Quét bù',
  'settings.mailIngest.catchUpHint': 'Quét 30 ngày gần nhất để tìm các đặt chỗ mà TREK có thể đã bỏ sót.',
  ...
  'settings.mailIngest.activityEmpty': 'Chưa có hoạt động nào.',
  ...
  'settings.mailIngest.status.pending': 'Cần xem xét',
  ...
  'settings.mailIngest.toast.testFailed': 'Kiểm tra thất bại: {error}',
  'settings.mailIngest.toast.connected': 'Đã kết nối hộp thư',
  'settings.mailIngest.toast.caughtUp': 'Đã hoàn tất — {imported} đã nhập, {pending} cần xem xét, {skipped} đã bỏ qua',
