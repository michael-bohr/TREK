...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'Nhập email: đã nhập đặt chỗ',
  'settings.notifyMailIngestPending': 'Nhập email: đặt chỗ cần xem lại',
  'settings.mailIngest.title': 'Nhập email',
  'settings.mailIngest.hint':
    'Kết nối hộp thư và TREK sẽ quét tìm xác nhận chuyến bay & khách sạn, đưa từng mục vào chuyến đi phù hợp (tự tạo nếu chưa có). TREK đọc hộp thư đến của bạn — đặt thư mục bên dưới để giới hạn, ví dụ một thư mục TREK riêng.',
  'settings.mailIngest.host': 'Máy chủ IMAP',
  'settings.mailIngest.port': 'Cổng',
  'settings.mailIngest.username': 'Tên người dùng',
  'settings.mailIngest.password': 'Mật khẩu (mật khẩu ứng dụng)',
  'settings.mailIngest.passwordHint': 'Dùng mật khẩu ứng dụng, không phải mật khẩu đăng nhập.',
  'settings.mailIngest.folder': 'Thư mục',
  'settings.mailIngest.folderHint': 'Mặc định là INBOX. Chọn thư mục riêng để TREK không đọc phần còn lại của hộp thư.',
  'settings.mailIngest.helpTitle': 'Tạo mật khẩu ứng dụng ở đâu?',
  'settings.mailIngest.helpBody':
    'Hầu hết nhà cung cấp chặn đăng nhập IMAP thông thường — hãy tạo mật khẩu ứng dụng, bật IMAP trong cài đặt email rồi dán vào ô trên.',
  'settings.mailIngest.testConnection': 'Kiểm tra kết nối',
  'settings.mailIngest.testing': 'Đang kiểm tra…',
  'settings.mailIngest.connect': 'Kết nối hộp thư',
  'settings.mailIngest.connecting': 'Đang kết nối…',
  'settings.mailIngest.lastChecked': 'kiểm tra lần cuối {time}',
  'settings.mailIngest.notCheckedYet': 'chưa kiểm tra',
  'settings.mailIngest.catchUp': 'Bắt kịp',
  'settings.mailIngest.catchUpHint': 'Quét 30 ngày gần nhất ngay',
  'settings.mailIngest.remove': 'Xóa',
  'settings.mailIngest.recentActivity': 'Hoạt động gần đây',
  'settings.mailIngest.activityEmpty': 'Chưa xử lý gì — chạy bắt kịp hoặc chờ lần kiểm tra định kỳ tiếp theo.',
  'settings.mailIngest.noSubject': '(không có tiêu đề)',
  'settings.mailIngest.addedCount': '(đã thêm {count})',
  'settings.mailIngest.status.imported': 'đã nhập',
  'settings.mailIngest.status.pending': 'đang chờ',
  'settings.mailIngest.status.error': 'lỗi',
  'settings.mailIngest.status.skipped': 'đã bỏ qua',
  'settings.mailIngest.toast.testOk': 'Kết nối thành công',
  'settings.mailIngest.toast.testFailed': 'Kết nối thất bại: {error}',
  'settings.mailIngest.toast.connected': 'Đã kết nối hộp thư',
  'settings.mailIngest.toast.caughtUp': 'Hoàn tất — đã thêm {imported}, {pending} cần xem lại, {skipped} bị bỏ qua',
