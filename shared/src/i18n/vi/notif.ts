...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.text': '"{subject}" đã được đưa vào {trip}',
  'notif.mail_ingest_pending.title': 'Đặt chỗ cần xem lại',
  'notif.mail_ingest_pending.text': '"{subject}" không khớp với chuyến đi nào ({reason})',
