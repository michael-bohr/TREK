...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.title': 'Đã nhập đặt chỗ',
  'notif.mail_ingest_imported.text': '"{subject}" đã được xếp vào {trip}',
  'notif.mail_ingest_pending.title': 'Đặt chỗ cần xem xét',
  'notif.mail_ingest_pending.text': '"{subject}" không thể khớp với chuyến đi nào ({reason})',
