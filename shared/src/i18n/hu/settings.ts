...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'Levélimport: foglalás importálva',
  'settings.notifyMailIngestPending': 'Levélimport: foglalás ellenőrzésre vár',
  ...
  'settings.mailIngest.title': 'Levélimport',
  'settings.mailIngest.hint':
    'Csatlakoztass egy postafiókot, és a TREK átvizsgálja repülő- és szállodai visszaigazolások után kutatva, majd automatikusan a megfelelő úthoz rendeli őket.',
  'settings.mailIngest.host': 'IMAP szerver',
  'settings.mailIngest.port': 'Port',
  'settings.mailIngest.username': 'E-mail cím',
  'settings.mailIngest.password': 'Jelszó',
  'settings.mailIngest.passwordHint':
    'A legtöbb szolgáltató alkalmazásjelszót igényel a szokásos jelszó helyett — lásd lent.',
  'settings.mailIngest.folder': 'Mappa',
  'settings.mailIngest.folderHint': 'Az átvizsgálandó IMAP mappa (alapértelmezés: INBOX).',
  'settings.mailIngest.helpTitle': 'Honnan szerezhetek alkalmazásjelszót?',
  'settings.mailIngest.helpBody':
    'A legtöbb szolgáltató blokkolja az egyszerű IMAP bejelentkezést, és generált alkalmazásjelszót igényel bekapcsolt IMAP-hozzáféréssel.',
  'settings.mailIngest.testConnection': 'Kapcsolat tesztelése',
  'settings.mailIngest.testing': 'Tesztelés…',
  'settings.mailIngest.connect': 'Csatlakozás',
  'settings.mailIngest.connecting': 'Csatlakozás…',
  'settings.mailIngest.remove': 'Eltávolítás',
  'settings.mailIngest.catchUp': 'Pótlás',
  'settings.mailIngest.catchUpHint':
    'Átvizsgálja az elmúlt 30 napot azokért a foglalásokért, amelyeket a TREK esetleg kihagyott.',
  ...
  'settings.mailIngest.activityEmpty': 'Még nincs tevékenység.',
  ...
  'settings.mailIngest.status.pending': 'Ellenőrzés szükséges',
  ...
  'settings.mailIngest.toast.testFailed': 'Sikertelen teszt: {error}',
  'settings.mailIngest.toast.connected': 'Postafiók csatlakoztatva',
  'settings.mailIngest.toast.caughtUp':
    'Pótolva — {imported} importálva, {pending} ellenőrzésre vár, {skipped} kihagyva',
