...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'E-mail-feldolgozás: foglalás importálva',
  'settings.notifyMailIngestPending': 'E-mail-feldolgozás: foglalás ellenőrzésre vár',
  'settings.mailIngest.title': 'E-mail-feldolgozás',
  'settings.mailIngest.hint':
    'Csatlakoztass egy postafiókot, és a TREK átvizsgálja repülő- és szállásfoglalási visszaigazolások után, majd a megfelelő úthoz rendeli őket (ha kell, létre is hozza). A beérkező leveleidet olvassa — alább megadhatsz egy mappát, pl. egy dedikált TREK mappát.',
  'settings.mailIngest.host': 'IMAP-kiszolgáló',
  'settings.mailIngest.port': 'Port',
  'settings.mailIngest.username': 'Felhasználónév',
  'settings.mailIngest.password': 'Jelszó (alkalmazásjelszó)',
  'settings.mailIngest.passwordHint': 'Alkalmazásjelszót használj, ne a bejelentkezési jelszavadat.',
  'settings.mailIngest.folder': 'Mappa',
  'settings.mailIngest.folderHint':
    'Alapértelmezés: INBOX. Válassz dedikált mappát, hogy a TREK ne férjen hozzá a többi leveledhez.',
  'settings.mailIngest.helpTitle': 'Hol hozhatok létre alkalmazásjelszót?',
  'settings.mailIngest.helpBody':
    'A legtöbb szolgáltató tiltja az egyszerű IMAP-bejelentkezést — hozz létre alkalmazásjelszót, ellenőrizd, hogy az IMAP engedélyezve van, majd illeszd be fent.',
  'settings.mailIngest.testConnection': 'Kapcsolat tesztelése',
  'settings.mailIngest.testing': 'Tesztelés…',
  'settings.mailIngest.connect': 'Postafiók csatlakoztatása',
  'settings.mailIngest.connecting': 'Csatlakozás…',
  'settings.mailIngest.lastChecked': 'utoljára ellenőrizve: {time}',
  'settings.mailIngest.notCheckedYet': 'még nem ellenőrizve',
  'settings.mailIngest.catchUp': 'Felzárkózás',
  'settings.mailIngest.catchUpHint': 'Az elmúlt 30 nap átvizsgálása most',
  'settings.mailIngest.remove': 'Eltávolítás',
  'settings.mailIngest.recentActivity': 'Legutóbbi tevékenység',
  'settings.mailIngest.activityEmpty':
    'Még nincs feldolgozott elem — indíts felzárkózást, vagy várd meg a következő ütemezett ellenőrzést.',
  'settings.mailIngest.noSubject': '(nincs tárgy)',
  'settings.mailIngest.addedCount': '({count} hozzáadva)',
  'settings.mailIngest.status.imported': 'importálva',
  'settings.mailIngest.status.pending': 'függőben',
  'settings.mailIngest.status.error': 'hiba',
  'settings.mailIngest.status.skipped': 'kihagyva',
  'settings.mailIngest.toast.testOk': 'Sikeres kapcsolat',
  'settings.mailIngest.toast.testFailed': 'Sikertelen kapcsolat: {error}',
  'settings.mailIngest.toast.connected': 'Postafiók csatlakoztatva',
  'settings.mailIngest.toast.caughtUp': 'Kész — {imported} hozzáadva, {pending} ellenőrzésre vár, {skipped} kihagyva',
