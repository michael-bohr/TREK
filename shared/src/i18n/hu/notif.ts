...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.title': 'Foglalás importálva',
  'notif.mail_ingest_imported.text': 'A(z) „{subject}” a(z) {trip} úthoz került',
  'notif.mail_ingest_pending.title': 'Foglalás ellenőrzésre vár',
  'notif.mail_ingest_pending.text': 'A(z) „{subject}” nem volt hozzárendelhető egyik úthoz sem ({reason})',
