...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'Ingesta de correo: reserva importada',
  'settings.notifyMailIngestPending': 'Ingesta de correo: reserva por revisar',
  'settings.mailIngest.title': 'Ingesta de correo',
  'settings.mailIngest.hint':
    'Conecta un buzón y TREK lo escanea en busca de confirmaciones de vuelos y hoteles, archivando cada una en el viaje correspondiente (creándolo si no existe). Lee tu bandeja de entrada para encontrar reservas; define abajo una carpeta para limitarlo, p. ej., una carpeta TREK dedicada.',
  'settings.mailIngest.host': 'Host IMAP',
  'settings.mailIngest.port': 'Puerto',
  'settings.mailIngest.username': 'Usuario',
  'settings.mailIngest.password': 'Contraseña (contraseña de aplicación)',
  'settings.mailIngest.passwordHint': 'Usa una contraseña de aplicación, no tu contraseña de inicio de sesión.',
  'settings.mailIngest.folder': 'Carpeta',
  'settings.mailIngest.folderHint':
    'INBOX por defecto. Usa una carpeta dedicada para que TREK no acceda al resto de tu correo.',
  'settings.mailIngest.helpTitle': '¿Dónde creo una contraseña de aplicación?',
  'settings.mailIngest.helpBody':
    'La mayoría de los proveedores bloquean los inicios de sesión IMAP simples: genera una contraseña de aplicación, asegúrate de que IMAP esté habilitado en tu correo y pégala arriba.',
  'settings.mailIngest.testConnection': 'Probar conexión',
  'settings.mailIngest.testing': 'Probando…',
  'settings.mailIngest.connect': 'Conectar buzón',
  'settings.mailIngest.connecting': 'Conectando…',
  'settings.mailIngest.lastChecked': 'última comprobación {time}',
  'settings.mailIngest.notCheckedYet': 'aún sin comprobar',
  'settings.mailIngest.catchUp': 'Ponerse al día',
  'settings.mailIngest.catchUpHint': 'Escanear los últimos 30 días ahora',
  'settings.mailIngest.remove': 'Eliminar',
  'settings.mailIngest.recentActivity': 'Actividad reciente',
  'settings.mailIngest.activityEmpty':
    'Aún no se ha procesado nada: ejecuta una puesta al día o espera a la próxima comprobación programada.',
  'settings.mailIngest.noSubject': '(sin asunto)',
  'settings.mailIngest.addedCount': '({count} añadidas)',
  'settings.mailIngest.status.imported': 'importada',
  'settings.mailIngest.status.pending': 'pendiente',
  'settings.mailIngest.status.error': 'error',
  'settings.mailIngest.status.skipped': 'omitida',
  'settings.mailIngest.toast.testOk': 'Conexión correcta',
  'settings.mailIngest.toast.testFailed': 'Error de conexión: {error}',
  'settings.mailIngest.toast.connected': 'Buzón conectado',
  'settings.mailIngest.toast.caughtUp': 'Al día — {imported} añadidas, {pending} por revisar, {skipped} omitidas',
