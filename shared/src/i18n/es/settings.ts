...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'Importación de correo: reserva importada',
  'settings.notifyMailIngestPending': 'Importación de correo: reserva requiere revisión',
  ...
  'settings.mailIngest.title': 'Importación de correo',
  'settings.mailIngest.hint':
    'Conecta un buzón y TREK lo revisa en busca de confirmaciones de vuelo y hotel, archivándolas automáticamente en el viaje correcto.',
  'settings.mailIngest.host': 'Servidor IMAP',
  'settings.mailIngest.port': 'Puerto',
  'settings.mailIngest.username': 'Correo electrónico',
  'settings.mailIngest.password': 'Contraseña',
  'settings.mailIngest.passwordHint':
    'La mayoría de los proveedores requieren una contraseña de aplicación en lugar de tu contraseña habitual — ver abajo.',
  'settings.mailIngest.folder': 'Carpeta',
  'settings.mailIngest.folderHint': 'Carpeta IMAP a analizar en busca de reservas (INBOX por defecto).',
  'settings.mailIngest.helpTitle': '¿Dónde obtengo una contraseña de aplicación?',
  'settings.mailIngest.helpBody':
    'La mayoría de los proveedores bloquean los inicios de sesión IMAP normales y requieren una contraseña de aplicación generada con el acceso IMAP activado.',
  'settings.mailIngest.testConnection': 'Probar conexión',
  'settings.mailIngest.testing': 'Probando…',
  'settings.mailIngest.connect': 'Conectar',
  'settings.mailIngest.connecting': 'Conectando…',
  'settings.mailIngest.remove': 'Eliminar',
  'settings.mailIngest.catchUp': 'Ponerse al día',
  'settings.mailIngest.catchUpHint':
    'Revisa los últimos 30 días en busca de reservas que TREK pueda haber pasado por alto.',
  'settings.mailIngest.lastChecked': 'Última comprobación {time}',
  'settings.mailIngest.notCheckedYet': 'Aún no comprobado',
  'settings.mailIngest.recentActivity': 'Actividad reciente',
  'settings.mailIngest.activityEmpty': 'Sin actividad todavía.',
  'settings.mailIngest.noSubject': '(sin asunto)',
  'settings.mailIngest.addedCount': '{count} añadida(s)',
  'settings.mailIngest.status.imported': 'Importada',
  'settings.mailIngest.status.pending': 'Requiere revisión',
  ...
  'settings.mailIngest.toast.testFailed': 'Prueba fallida: {error}',
  'settings.mailIngest.toast.connected': 'Buzón conectado',
  'settings.mailIngest.toast.caughtUp': 'Actualizado — {imported} importadas, {pending} pendientes, {skipped} omitidas',
