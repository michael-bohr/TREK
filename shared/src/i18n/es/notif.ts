...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.text': '"{subject}" se archivó en {trip}',
  'notif.mail_ingest_pending.title': 'Reserva requiere revisión',
  'notif.mail_ingest_pending.text': '"{subject}" no se pudo asociar a un viaje ({reason})',
