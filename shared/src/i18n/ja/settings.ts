...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'メール取り込み: 予約を取り込みました',
  'settings.notifyMailIngestPending': 'メール取り込み: 予約の確認が必要です',
  ...
  'settings.mailIngest.hint':
    'メールボックスを接続すると、TREKがフライトやホテルの確認メールをスキャンし、自動的に該当する旅程に登録します。',
  'settings.mailIngest.host': 'IMAPサーバー',
  'settings.mailIngest.port': 'ポート',
  'settings.mailIngest.username': 'メールアドレス',
  'settings.mailIngest.password': 'パスワード',
  ...
  'settings.mailIngest.connect': '接続',
  'settings.mailIngest.connecting': '接続中…',
  'settings.mailIngest.remove': '削除',
  'settings.mailIngest.catchUp': '過去分を取り込む',
  'settings.mailIngest.catchUpHint': 'TREKが見逃した可能性のある予約がないか、過去30日分をスキャンします。',
  ...
  'settings.mailIngest.toast.testFailed': 'テストに失敗しました: {error}',
  'settings.mailIngest.toast.connected': 'メールボックスを接続しました',
  'settings.mailIngest.toast.caughtUp': '完了 — 取り込み{imported}件、要確認{pending}件、スキップ{skipped}件',
