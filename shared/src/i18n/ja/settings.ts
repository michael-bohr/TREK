...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'メール取り込み：予約をインポートしました',
  'settings.notifyMailIngestPending': 'メール取り込み：要確認の予約',
  'settings.mailIngest.title': 'メール取り込み',
  'settings.mailIngest.hint':
    'メールボックスを接続すると、TREKがフライトやホテルの確認メールをスキャンし、該当する旅行に自動で振り分けます（旅行がなければ作成します）。受信トレイを読み取って予約を探します。下でフォルダーを指定すると、専用のTREKフォルダーなどに限定できます。',
  'settings.mailIngest.host': 'IMAPホスト',
  'settings.mailIngest.port': 'ポート',
  'settings.mailIngest.username': 'ユーザー名',
  'settings.mailIngest.password': 'パスワード（アプリパスワード）',
  'settings.mailIngest.passwordHint': 'ログインパスワードではなくアプリパスワードを使用してください。',
  'settings.mailIngest.folder': 'フォルダー',
  'settings.mailIngest.folderHint': '既定はINBOXです。専用フォルダーを指定すると、TREKが他のメールにアクセスしません。',
  'settings.mailIngest.helpTitle': 'アプリパスワードはどこで作成できますか？',
  'settings.mailIngest.helpBody':
    '多くのプロバイダーは通常のIMAPログインをブロックしています。アプリパスワードを作成し、メール設定でIMAPが有効になっていることを確認して、上に貼り付けてください。',
  'settings.mailIngest.testConnection': '接続をテスト',
  'settings.mailIngest.testing': 'テスト中…',
  'settings.mailIngest.connect': 'メールボックスを接続',
  'settings.mailIngest.connecting': '接続中…',
  'settings.mailIngest.lastChecked': '最終確認 {time}',
  'settings.mailIngest.notCheckedYet': '未確認',
  'settings.mailIngest.catchUp': 'キャッチアップ',
  'settings.mailIngest.catchUpHint': '過去30日間を今すぐスキャン',
  'settings.mailIngest.remove': '削除',
  'settings.mailIngest.recentActivity': '最近のアクティビティ',
  'settings.mailIngest.activityEmpty': 'まだ処理はありません。キャッチアップを実行するか、次回の定期チェックをお待ちください。',
  'settings.mailIngest.noSubject': '（件名なし）',
  'settings.mailIngest.addedCount': '（{count}件追加）',
  'settings.mailIngest.status.imported': 'インポート済み',
  'settings.mailIngest.status.pending': '保留',
  'settings.mailIngest.status.error': 'エラー',
  'settings.mailIngest.status.skipped': 'スキップ',
  'settings.mailIngest.toast.testOk': '接続に成功しました',
  'settings.mailIngest.toast.testFailed': '接続に失敗しました：{error}',
  'settings.mailIngest.toast.connected': 'メールボックスを接続しました',
  'settings.mailIngest.toast.caughtUp': '完了 — {imported}件追加、{pending}件要確認、{skipped}件スキップ',
