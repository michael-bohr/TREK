...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.title': '予約をインポートしました',
  'notif.mail_ingest_imported.text': '「{subject}」を{trip}に追加しました',
  'notif.mail_ingest_pending.title': '要確認の予約',
  'notif.mail_ingest_pending.text': '「{subject}」はどの旅行にも一致しませんでした（{reason}）',
