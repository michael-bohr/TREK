...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'Importação de e-mail: reserva importada',
  'settings.notifyMailIngestPending': 'Importação de e-mail: reserva requer revisão',
  ...
  'settings.mailIngest.title': 'Importação de e-mail',
  'settings.mailIngest.hint':
    'Conecte uma caixa de e-mail e o TREK a verifica em busca de confirmações de voo e hotel, arquivando-as automaticamente na viagem certa.',
  'settings.mailIngest.host': 'Servidor IMAP',
  'settings.mailIngest.port': 'Porta',
  'settings.mailIngest.username': 'Endereço de e-mail',
  'settings.mailIngest.password': 'Senha',
  'settings.mailIngest.passwordHint':
    'A maioria dos provedores exige uma senha de aplicativo em vez da sua senha normal — veja abaixo.',
  'settings.mailIngest.folder': 'Pasta',
  'settings.mailIngest.folderHint': 'Pasta IMAP a verificar em busca de reservas (INBOX por padrão).',
  'settings.mailIngest.helpTitle': 'Onde consigo uma senha de aplicativo?',
  'settings.mailIngest.helpBody':
    'A maioria dos provedores bloqueia logins IMAP simples e exige uma senha de aplicativo gerada com o acesso IMAP ativado.',
  ...
  'settings.mailIngest.catchUpHint': 'Verifica os últimos 30 dias em busca de reservas que o TREK possa ter perdido.',
  ...
  'settings.mailIngest.activityEmpty': 'Nenhuma atividade ainda.',
  'settings.mailIngest.noSubject': '(sem assunto)',
  'settings.mailIngest.addedCount': '{count} adicionada(s)',
  'settings.mailIngest.status.imported': 'Importada',
  'settings.mailIngest.status.pending': 'Requer revisão',
  ...
  'settings.mailIngest.toast.testFailed': 'Teste falhou: {error}',
  'settings.mailIngest.toast.connected': 'Caixa de e-mail conectada',
  'settings.mailIngest.toast.caughtUp': 'Atualizado — {imported} importadas, {pending} pendentes, {skipped} ignoradas',
