...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'Ingestão de e-mail: reserva importada',
  'settings.notifyMailIngestPending': 'Ingestão de e-mail: reserva para revisar',
  'settings.mailIngest.title': 'Ingestão de e-mail',
  'settings.mailIngest.hint':
    'Conecte uma caixa de e-mail e o TREK a examina em busca de confirmações de voos e hotéis, arquivando cada uma na viagem correspondente (criando-a se não existir). Ele lê sua caixa de entrada para encontrar reservas — defina uma pasta abaixo para limitar, por ex., a uma pasta TREK dedicada.',
  'settings.mailIngest.host': 'Host IMAP',
  'settings.mailIngest.port': 'Porta',
  'settings.mailIngest.username': 'Usuário',
  'settings.mailIngest.password': 'Senha (senha de app)',
  'settings.mailIngest.passwordHint': 'Use uma senha de app, não sua senha de login.',
  'settings.mailIngest.folder': 'Pasta',
  'settings.mailIngest.folderHint':
    'Padrão: INBOX. Aponte para uma pasta dedicada para manter o TREK fora do restante do seu e-mail.',
  'settings.mailIngest.helpTitle': 'Onde crio uma senha de app?',
  'settings.mailIngest.helpBody':
    'A maioria dos provedores bloqueia logins IMAP simples — gere uma senha de app, confirme que o IMAP está ativado nas configurações do seu e-mail e cole-a acima.',
  'settings.mailIngest.testConnection': 'Testar conexão',
  'settings.mailIngest.testing': 'Testando…',
  'settings.mailIngest.connect': 'Conectar caixa de e-mail',
  'settings.mailIngest.connecting': 'Conectando…',
  'settings.mailIngest.lastChecked': 'última verificação {time}',
  'settings.mailIngest.notCheckedYet': 'ainda não verificado',
  'settings.mailIngest.catchUp': 'Atualizar',
  'settings.mailIngest.catchUpHint': 'Examinar os últimos 30 dias agora',
  'settings.mailIngest.remove': 'Remover',
  'settings.mailIngest.recentActivity': 'Atividade recente',
  'settings.mailIngest.activityEmpty':
    'Nada processado ainda — execute uma atualização ou aguarde a próxima verificação agendada.',
  'settings.mailIngest.noSubject': '(sem assunto)',
  'settings.mailIngest.addedCount': '({count} adicionadas)',
  'settings.mailIngest.status.imported': 'importada',
  'settings.mailIngest.status.pending': 'pendente',
  'settings.mailIngest.status.error': 'erro',
  'settings.mailIngest.status.skipped': 'ignorada',
  'settings.mailIngest.toast.testOk': 'Conexão bem-sucedida',
  'settings.mailIngest.toast.testFailed': 'Falha na conexão: {error}',
  'settings.mailIngest.toast.connected': 'Caixa de e-mail conectada',
  'settings.mailIngest.toast.caughtUp':
    'Atualizado — {imported} adicionadas, {pending} para revisar, {skipped} ignoradas',
