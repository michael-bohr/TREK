...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.text': '"{subject}" foi arquivada em {trip}',
  'notif.mail_ingest_pending.title': 'Reserva requer revisão',
  'notif.mail_ingest_pending.text': '"{subject}" não pôde ser associada a uma viagem ({reason})',
