...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': '메일 가져오기: 예약 가져옴',
  'settings.notifyMailIngestPending': '메일 가져오기: 예약 검토 필요',
  ...
  'settings.mailIngest.title': '메일 가져오기',
  'settings.mailIngest.hint':
    '메일함을 연결하면 TREK이 항공편 및 호텔 확인 메일을 검색하여 알맞은 여행에 자동으로 등록합니다.',
  'settings.mailIngest.host': 'IMAP 서버',
  'settings.mailIngest.port': '포트',
  'settings.mailIngest.username': '이메일 주소',
  'settings.mailIngest.password': '비밀번호',
  'settings.mailIngest.passwordHint':
    '대부분의 제공업체는 일반 비밀번호 대신 앱 비밀번호가 필요합니다 — 아래를 참조하세요.',
  'settings.mailIngest.folder': '폴더',
  'settings.mailIngest.folderHint': '예약을 검색할 IMAP 폴더입니다(기본값 INBOX).',
  'settings.mailIngest.helpTitle': '앱 비밀번호는 어디서 얻나요?',
  'settings.mailIngest.helpBody':
    '대부분의 제공업체는 일반 IMAP 로그인을 차단하며, IMAP 액세스가 활성화된 상태로 생성된 앱 비밀번호가 필요합니다.',
  'settings.mailIngest.testConnection': '연결 테스트',
  'settings.mailIngest.testing': '테스트 중…',
  'settings.mailIngest.connect': '연결',
  'settings.mailIngest.connecting': '연결 중…',
  'settings.mailIngest.remove': '제거',
  'settings.mailIngest.catchUp': '지난 내역 가져오기',
  'settings.mailIngest.catchUpHint': 'TREK이 놓쳤을 수 있는 예약을 찾기 위해 지난 30일을 검색합니다.',
  'settings.mailIngest.lastChecked': '마지막 확인 {time}',
  'settings.mailIngest.notCheckedYet': '아직 확인하지 않음',
  'settings.mailIngest.recentActivity': '최근 활동',
  'settings.mailIngest.activityEmpty': '아직 활동이 없습니다.',
  'settings.mailIngest.noSubject': '(제목 없음)',
  'settings.mailIngest.addedCount': '{count}건 추가됨',
  'settings.mailIngest.status.imported': '가져옴',
  'settings.mailIngest.status.pending': '검토 필요',
  'settings.mailIngest.status.error': '오류',
  'settings.mailIngest.status.skipped': '건너뜀',
  'settings.mailIngest.toast.testOk': '연결 성공',
  'settings.mailIngest.toast.testFailed': '테스트 실패: {error}',
  'settings.mailIngest.toast.connected': '메일함이 연결되었습니다',
  'settings.mailIngest.toast.caughtUp': '완료 — {imported}건 가져옴, {pending}건 검토 필요, {skipped}건 건너뜀',
