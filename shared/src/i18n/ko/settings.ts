...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': '메일 수집: 예약 가져옴',
  'settings.notifyMailIngestPending': '메일 수집: 확인이 필요한 예약',
  'settings.mailIngest.title': '메일 수집',
  'settings.mailIngest.hint':
    '메일함을 연결하면 TREK가 항공·호텔 확인 메일을 검색해 해당 여행에 자동으로 정리합니다(여행이 없으면 새로 만듭니다). 받은편지함을 읽어 예약을 찾습니다. 아래에서 폴더를 지정하면 전용 TREK 폴더 등으로 범위를 제한할 수 있습니다.',
  'settings.mailIngest.host': 'IMAP 호스트',
  'settings.mailIngest.port': '포트',
  'settings.mailIngest.username': '사용자 이름',
  'settings.mailIngest.password': '비밀번호(앱 비밀번호)',
  'settings.mailIngest.passwordHint': '로그인 비밀번호가 아닌 앱 비밀번호를 사용하세요.',
  'settings.mailIngest.folder': '폴더',
  'settings.mailIngest.folderHint': '기본값은 INBOX입니다. 전용 폴더를 지정하면 TREK가 나머지 메일에 접근하지 않습니다.',
  'settings.mailIngest.helpTitle': '앱 비밀번호는 어디서 만드나요?',
  'settings.mailIngest.helpBody':
    '대부분의 제공업체는 일반 IMAP 로그인을 차단합니다. 앱 비밀번호를 생성하고 메일 설정에서 IMAP이 활성화되어 있는지 확인한 뒤 위에 붙여넣으세요.',
  'settings.mailIngest.testConnection': '연결 테스트',
  'settings.mailIngest.testing': '테스트 중…',
  'settings.mailIngest.connect': '메일함 연결',
  'settings.mailIngest.connecting': '연결 중…',
  'settings.mailIngest.lastChecked': '마지막 확인 {time}',
  'settings.mailIngest.notCheckedYet': '아직 확인 안 됨',
  'settings.mailIngest.catchUp': '따라잡기',
  'settings.mailIngest.catchUpHint': '지금 최근 30일 검색',
  'settings.mailIngest.remove': '제거',
  'settings.mailIngest.recentActivity': '최근 활동',
  'settings.mailIngest.activityEmpty': '아직 처리된 항목이 없습니다. 따라잡기를 실행하거나 다음 예약된 확인을 기다리세요.',
  'settings.mailIngest.noSubject': '(제목 없음)',
  'settings.mailIngest.addedCount': '({count}개 추가됨)',
  'settings.mailIngest.status.imported': '가져옴',
  'settings.mailIngest.status.pending': '대기 중',
  'settings.mailIngest.status.error': '오류',
  'settings.mailIngest.status.skipped': '건너뜀',
  'settings.mailIngest.toast.testOk': '연결 성공',
  'settings.mailIngest.toast.testFailed': '연결 실패: {error}',
  'settings.mailIngest.toast.connected': '메일함 연결됨',
  'settings.mailIngest.toast.caughtUp': '완료 — {imported}개 추가, {pending}개 확인 필요, {skipped}개 건너뜀',
