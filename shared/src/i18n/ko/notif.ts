...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.title': '예약을 가져왔습니다',
  'notif.mail_ingest_imported.text': '"{subject}"이(가) {trip}에 등록되었습니다',
  'notif.mail_ingest_pending.title': '예약 검토가 필요합니다',
  'notif.mail_ingest_pending.text': '"{subject}"을(를) 여행과 연결하지 못했습니다 ({reason})',
