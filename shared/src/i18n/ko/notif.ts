...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.title': '예약 가져옴',
  'notif.mail_ingest_imported.text': '"{subject}"이(가) {trip}에 추가되었습니다',
  'notif.mail_ingest_pending.title': '확인이 필요한 예약',
  'notif.mail_ingest_pending.text': '"{subject}"을(를) 여행에 연결하지 못했습니다({reason})',
