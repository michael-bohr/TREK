...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'Mailimport: bokning importerad',
  'settings.notifyMailIngestPending': 'Mailimport: bokning att granska',
  'settings.mailIngest.title': 'Mailimport',
  'settings.mailIngest.hint':
    'Anslut en brevlåda så söker TREK igenom den efter flyg- och hotellbekräftelser och lägger dem på rätt resa (skapar den om den saknas). Din inkorg läses för att hitta bokningar — ange en mapp nedan för att begränsa, t.ex. en särskild TREK-mapp.',
  'settings.mailIngest.host': 'IMAP-värd',
  'settings.mailIngest.port': 'Port',
  'settings.mailIngest.username': 'Användarnamn',
  'settings.mailIngest.password': 'Lösenord (applösenord)',
  'settings.mailIngest.passwordHint': 'Använd ett applösenord, inte ditt inloggningslösenord.',
  'settings.mailIngest.folder': 'Mapp',
  'settings.mailIngest.folderHint':
    'Standard INBOX. Välj en särskild mapp så att TREK inte läser resten av din e-post.',
  'settings.mailIngest.helpTitle': 'Var skapar jag ett applösenord?',
  'settings.mailIngest.helpBody':
    'De flesta leverantörer blockerar vanliga IMAP-inloggningar — skapa ett applösenord, kontrollera att IMAP är aktiverat i dina e-postinställningar och klistra in det ovan.',
  'settings.mailIngest.testConnection': 'Testa anslutning',
  'settings.mailIngest.testing': 'Testar…',
  'settings.mailIngest.connect': 'Anslut brevlåda',
  'settings.mailIngest.connecting': 'Ansluter…',
  'settings.mailIngest.lastChecked': 'senast kontrollerad {time}',
  'settings.mailIngest.notCheckedYet': 'inte kontrollerad än',
  'settings.mailIngest.catchUp': 'Kom ikapp',
  'settings.mailIngest.catchUpHint': 'Skanna de senaste 30 dagarna nu',
  'settings.mailIngest.remove': 'Ta bort',
  'settings.mailIngest.recentActivity': 'Senaste aktivitet',
  'settings.mailIngest.activityEmpty':
    'Inget bearbetat än — kör en ikappkörning eller vänta på nästa schemalagda kontroll.',
  'settings.mailIngest.noSubject': '(inget ämne)',
  'settings.mailIngest.addedCount': '({count} tillagda)',
  'settings.mailIngest.status.imported': 'importerad',
  'settings.mailIngest.status.pending': 'väntar',
  'settings.mailIngest.status.error': 'fel',
  'settings.mailIngest.status.skipped': 'överhoppad',
  'settings.mailIngest.toast.testOk': 'Anslutningen lyckades',
  'settings.mailIngest.toast.testFailed': 'Anslutningen misslyckades: {error}',
  'settings.mailIngest.toast.connected': 'Brevlådan ansluten',
  'settings.mailIngest.toast.caughtUp': 'Klart — {imported} tillagda, {pending} att granska, {skipped} överhoppade',
