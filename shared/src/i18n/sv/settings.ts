...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'E-postimport: bokning importerad',
  'settings.notifyMailIngestPending': 'E-postimport: bokning behöver granskas',
  ...
  'settings.mailIngest.title': 'E-postimport',
  'settings.mailIngest.hint':
    'Anslut en brevlåda så letar TREK igenom den efter flyg- och hotellbekräftelser och lägger dem automatiskt på rätt resa.',
  'settings.mailIngest.host': 'IMAP-server',
  'settings.mailIngest.port': 'Port',
  'settings.mailIngest.username': 'E-postadress',
  'settings.mailIngest.password': 'Lösenord',
  'settings.mailIngest.passwordHint':
    'De flesta leverantörer kräver ett app-lösenord istället för ditt vanliga lösenord — se nedan.',
  'settings.mailIngest.folder': 'Mapp',
  'settings.mailIngest.folderHint': 'IMAP-mapp att söka igenom efter bokningar (standard INBOX).',
  'settings.mailIngest.helpTitle': 'Var får jag ett app-lösenord?',
  'settings.mailIngest.helpBody':
    'De flesta leverantörer blockerar vanliga IMAP-inloggningar och kräver ett genererat app-lösenord med IMAP-åtkomst aktiverad.',
  'settings.mailIngest.testConnection': 'Testa anslutning',
  'settings.mailIngest.testing': 'Testar…',
  'settings.mailIngest.connect': 'Anslut',
  'settings.mailIngest.connecting': 'Ansluter…',
  'settings.mailIngest.remove': 'Ta bort',
  'settings.mailIngest.catchUp': 'Hämta in',
  'settings.mailIngest.catchUpHint': 'Söker igenom de senaste 30 dagarna efter bokningar som TREK kan ha missat.',
  'settings.mailIngest.lastChecked': 'Senast kontrollerad {time}',
  'settings.mailIngest.notCheckedYet': 'Inte kontrollerad ännu',
  'settings.mailIngest.recentActivity': 'Senaste aktivitet',
  'settings.mailIngest.activityEmpty': 'Ingen aktivitet ännu.',
  ...
  'settings.mailIngest.status.pending': 'Behöver granskas',
  ...
  'settings.mailIngest.toast.testFailed': 'Testet misslyckades: {error}',
  'settings.mailIngest.toast.connected': 'Brevlåda ansluten',
  'settings.mailIngest.toast.caughtUp': 'Klart — {imported} importerade, {pending} att granska, {skipped} överhoppade',
