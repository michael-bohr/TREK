...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.title': 'Buchung importiert',
  'notif.mail_ingest_imported.text': '"{subject}" wurde {trip} zugeordnet',
  'notif.mail_ingest_pending.title': 'Buchung muss geprüft werden',
  'notif.mail_ingest_pending.text': '"{subject}" konnte keiner Reise zugeordnet werden ({reason})',
