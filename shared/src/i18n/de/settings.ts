...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'Mail-Import: Buchung importiert',
  'settings.notifyMailIngestPending': 'Mail-Import: Buchung zu prüfen',
  'settings.mailIngest.title': 'Mail-Import',
  'settings.mailIngest.hint':
    'Verbinde ein Postfach und TREK durchsucht es nach Flug- und Hotelbestätigungen und ordnet sie der passenden Reise zu (oder legt eine neue an). Dein Posteingang wird nach Buchungen durchsucht — lege unten einen Ordner fest, um die Suche z. B. auf einen eigenen TREK-Ordner zu beschränken.',
  'settings.mailIngest.host': 'IMAP-Host',
  'settings.mailIngest.port': 'Port',
  'settings.mailIngest.username': 'Benutzername',
  'settings.mailIngest.password': 'Passwort (App-Passwort)',
  'settings.mailIngest.passwordHint': 'Verwende ein App-Passwort, nicht dein Login-Passwort.',
  'settings.mailIngest.folder': 'Ordner',
  'settings.mailIngest.folderHint':
    'Standard: INBOX. Wähle einen eigenen Ordner, damit TREK den Rest deiner Mails nicht liest.',
  'settings.mailIngest.helpTitle': 'Wo erstelle ich ein App-Passwort?',
  'settings.mailIngest.helpBody':
    'Die meisten Anbieter blockieren einfache IMAP-Logins — erstelle ein App-Passwort, aktiviere IMAP in deinen Mail-Einstellungen und füge es oben ein.',
  'settings.mailIngest.testConnection': 'Verbindung testen',
  'settings.mailIngest.testing': 'Teste…',
  'settings.mailIngest.connect': 'Postfach verbinden',
  'settings.mailIngest.connecting': 'Verbinde…',
  'settings.mailIngest.lastChecked': 'zuletzt geprüft {time}',
  'settings.mailIngest.notCheckedYet': 'noch nicht geprüft',
  'settings.mailIngest.catchUp': 'Aufholen',
  'settings.mailIngest.catchUpHint': 'Jetzt die letzten 30 Tage durchsuchen',
  'settings.mailIngest.remove': 'Entfernen',
  'settings.mailIngest.recentActivity': 'Letzte Aktivität',
  'settings.mailIngest.activityEmpty':
    'Noch nichts verarbeitet — starte einen Abruf oder warte auf die nächste geplante Prüfung.',
  'settings.mailIngest.noSubject': '(kein Betreff)',
  'settings.mailIngest.addedCount': '({count} hinzugefügt)',
  'settings.mailIngest.status.imported': 'importiert',
  'settings.mailIngest.status.pending': 'zu prüfen',
  'settings.mailIngest.status.error': 'Fehler',
  'settings.mailIngest.status.skipped': 'übersprungen',
  'settings.mailIngest.toast.testOk': 'Verbindung erfolgreich',
  'settings.mailIngest.toast.testFailed': 'Verbindung fehlgeschlagen: {error}',
  'settings.mailIngest.toast.connected': 'Postfach verbunden',
  'settings.mailIngest.toast.caughtUp':
    'Aufgeholt — {imported} hinzugefügt, {pending} zu prüfen, {skipped} übersprungen',
