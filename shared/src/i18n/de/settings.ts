...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestPending': 'Mail-Import: Buchung muss geprüft werden',
  ...
  'settings.mailIngest.hint':
    'Verbinde ein Postfach, und TREK durchsucht es nach Flug- und Hotelbestätigungen und ordnet sie automatisch der richtigen Reise zu.',
  'settings.mailIngest.host': 'IMAP-Server',
  'settings.mailIngest.port': 'Port',
  'settings.mailIngest.username': 'E-Mail-Adresse',
  'settings.mailIngest.password': 'Passwort',
  'settings.mailIngest.passwordHint':
    'Die meisten Anbieter verlangen statt deines normalen Passworts ein App-Passwort — siehe unten.',
  'settings.mailIngest.folder': 'Ordner',
  'settings.mailIngest.folderHint': 'IMAP-Ordner, der durchsucht wird (Standard: INBOX).',
  'settings.mailIngest.helpTitle': 'Wo bekomme ich ein App-Passwort?',
  'settings.mailIngest.helpBody':
    'Die meisten Anbieter blockieren einfache IMAP-Logins und verlangen ein generiertes App-Passwort mit aktiviertem IMAP-Zugriff.',
  'settings.mailIngest.testConnection': 'Verbindung testen',
  'settings.mailIngest.testing': 'Wird getestet…',
  'settings.mailIngest.connect': 'Verbinden',
  'settings.mailIngest.connecting': 'Wird verbunden…',
  'settings.mailIngest.remove': 'Entfernen',
  'settings.mailIngest.catchUp': 'Nachholen',
  'settings.mailIngest.catchUpHint':
    'Durchsucht die letzten 30 Tage nach Buchungen, die TREK möglicherweise übersehen hat.',
  ...
  'settings.mailIngest.activityEmpty': 'Noch keine Aktivität.',
  ...
  'settings.mailIngest.status.pending': 'Prüfung nötig',
  ...
  'settings.mailIngest.toast.testFailed': 'Test fehlgeschlagen: {error}',
  'settings.mailIngest.toast.connected': 'Postfach verbunden',
  'settings.mailIngest.toast.caughtUp':
    'Nachgeholt — {imported} importiert, {pending} zu prüfen, {skipped} übersprungen',
