...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.title': 'تم استيراد الحجز',
  'notif.mail_ingest_imported.text': 'تمت إضافة "{subject}" إلى {trip}',
  'notif.mail_ingest_pending.title': 'حجز بحاجة إلى مراجعة',
  'notif.mail_ingest_pending.text': 'تعذّر مطابقة "{subject}" مع أي رحلة ({reason})',
