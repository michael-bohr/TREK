...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.text': 'تمت أرشفة "{subject}" في {trip}',
  'notif.mail_ingest_pending.title': 'الحجز يتطلب مراجعة',
  'notif.mail_ingest_pending.text': 'تعذّرت مطابقة "{subject}" مع أي رحلة ({reason})',
