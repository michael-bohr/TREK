...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestPending': 'استيراد البريد: الحجز يتطلب مراجعة',
  ...
  'settings.mailIngest.hint':
    'اربط صندوق بريد ليقوم TREK بفحصه بحثًا عن تأكيدات الرحلات الجوية والفنادق، وأرشفتها تلقائيًا في الرحلة الصحيحة.',
  'settings.mailIngest.host': 'خادم IMAP',
  'settings.mailIngest.port': 'المنفذ',
  'settings.mailIngest.username': 'عنوان البريد الإلكتروني',
  'settings.mailIngest.password': 'كلمة المرور',
  'settings.mailIngest.passwordHint':
    'تتطلب معظم مزودي الخدمة كلمة مرور للتطبيق بدلاً من كلمة مرورك المعتادة — انظر أدناه.',
  'settings.mailIngest.folder': 'المجلد',
  'settings.mailIngest.folderHint': 'مجلد IMAP المراد فحصه بحثًا عن الحجوزات (الافتراضي INBOX).',
  'settings.mailIngest.helpTitle': 'من أين أحصل على كلمة مرور للتطبيق؟',
  'settings.mailIngest.helpBody':
    'تحظر معظم مزودي الخدمة تسجيلات الدخول العادية عبر IMAP وتتطلب كلمة مرور تطبيق تم إنشاؤها مع تفعيل الوصول عبر IMAP.',
  'settings.mailIngest.testConnection': 'اختبار الاتصال',
  'settings.mailIngest.testing': 'جارٍ الاختبار…',
  'settings.mailIngest.connect': 'اتصال',
  'settings.mailIngest.connecting': 'جارٍ الاتصال…',
  'settings.mailIngest.remove': 'إزالة',
  'settings.mailIngest.catchUp': 'فحص الفترة الفائتة',
  'settings.mailIngest.catchUpHint': 'يفحص آخر 30 يومًا بحثًا عن حجوزات ربما فاتت على TREK.',
  'settings.mailIngest.lastChecked': 'آخر فحص {time}',
  'settings.mailIngest.notCheckedYet': 'لم يتم الفحص بعد',
  'settings.mailIngest.recentActivity': 'النشاط الأخير',
  'settings.mailIngest.activityEmpty': 'لا يوجد نشاط بعد.',
  'settings.mailIngest.noSubject': '(بدون موضوع)',
  'settings.mailIngest.addedCount': 'تمت إضافة {count}',
  'settings.mailIngest.status.imported': 'تم الاستيراد',
  'settings.mailIngest.status.pending': 'يتطلب مراجعة',
  'settings.mailIngest.status.error': 'خطأ',
  'settings.mailIngest.status.skipped': 'تم التخطي',
  'settings.mailIngest.toast.testOk': 'تم الاتصال بنجاح',
  'settings.mailIngest.toast.testFailed': 'فشل الاختبار: {error}',
  'settings.mailIngest.toast.connected': 'تم اتصال صندوق البريد',
  'settings.mailIngest.toast.caughtUp': 'تم التحديث — تم استيراد {imported}، قيد المراجعة {pending}، تم تخطي {skipped}',
