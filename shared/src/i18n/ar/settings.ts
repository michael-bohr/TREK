...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'استيراد البريد: تم استيراد الحجز',
  'settings.notifyMailIngestPending': 'استيراد البريد: حجز بحاجة إلى مراجعة',
  'settings.mailIngest.title': 'استيراد البريد',
  'settings.mailIngest.hint':
    'اربط صندوق بريد وسيبحث TREK فيه عن تأكيدات الرحلات والفنادق ويضيف كلاً منها إلى الرحلة المناسبة (وينشئها إن لم تكن موجودة). يقرأ TREK بريدك الوارد للعثور على الحجوزات — حدّد مجلداً أدناه لتقييد البحث، مثل مجلد TREK مخصص.',
  'settings.mailIngest.host': 'خادم IMAP',
  'settings.mailIngest.port': 'المنفذ',
  'settings.mailIngest.username': 'اسم المستخدم',
  'settings.mailIngest.password': 'كلمة المرور (كلمة مرور التطبيق)',
  'settings.mailIngest.passwordHint': 'استخدم كلمة مرور تطبيق، وليس كلمة مرور تسجيل الدخول.',
  'settings.mailIngest.folder': 'المجلد',
  'settings.mailIngest.folderHint': 'الافتراضي INBOX. حدّد مجلداً مخصصاً لمنع TREK من قراءة بقية بريدك.',
  'settings.mailIngest.helpTitle': 'أين أنشئ كلمة مرور تطبيق؟',
  'settings.mailIngest.helpBody':
    'يحظر معظم مزوّدي البريد تسجيل الدخول العادي عبر IMAP — أنشئ كلمة مرور تطبيق، وتأكد من تفعيل IMAP في إعدادات بريدك، ثم الصقها أعلاه.',
  'settings.mailIngest.testConnection': 'اختبار الاتصال',
  'settings.mailIngest.testing': 'جارٍ الاختبار…',
  'settings.mailIngest.connect': 'ربط صندوق البريد',
  'settings.mailIngest.connecting': 'جارٍ الاتصال…',
  'settings.mailIngest.lastChecked': 'آخر فحص {time}',
  'settings.mailIngest.notCheckedYet': 'لم يُفحص بعد',
  'settings.mailIngest.catchUp': 'اللحاق',
  'settings.mailIngest.catchUpHint': 'افحص آخر 30 يوماً الآن',
  'settings.mailIngest.remove': 'إزالة',
  'settings.mailIngest.recentActivity': 'النشاط الأخير',
  'settings.mailIngest.activityEmpty': 'لم تتم معالجة أي شيء بعد — شغّل اللحاق أو انتظر الفحص المجدول التالي.',
  'settings.mailIngest.noSubject': '(بدون موضوع)',
  'settings.mailIngest.addedCount': '(أُضيف {count})',
  'settings.mailIngest.status.imported': 'مستورد',
  'settings.mailIngest.status.pending': 'قيد الانتظار',
  'settings.mailIngest.status.error': 'خطأ',
  'settings.mailIngest.status.skipped': 'تم التخطي',
  'settings.mailIngest.toast.testOk': 'نجح الاتصال',
  'settings.mailIngest.toast.testFailed': 'فشل الاتصال: {error}',
  'settings.mailIngest.toast.connected': 'تم ربط صندوق البريد',
  'settings.mailIngest.toast.caughtUp': 'اكتمل — أُضيف {imported}، {pending} بحاجة لمراجعة، {skipped} تم تخطيها',
