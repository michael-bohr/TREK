...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.title': '已导入预订',
  'notif.mail_ingest_imported.text': '“{subject}”已归入 {trip}',
  'notif.mail_ingest_pending.title': '待确认的预订',
  'notif.mail_ingest_pending.text': '“{subject}”无法匹配到任何行程（{reason}）',
