...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': '邮件导入：已导入预订',
  'settings.notifyMailIngestPending': '邮件导入：待确认的预订',
  'settings.mailIngest.title': '邮件导入',
  'settings.mailIngest.hint':
    '连接邮箱后，TREK 会扫描其中的机票和酒店确认邮件，并将其归入对应的行程（如无则自动创建）。TREK 会读取你的收件箱来查找预订 — 可在下方指定文件夹以限制范围，例如专用的 TREK 文件夹。',
  'settings.mailIngest.host': 'IMAP 服务器',
  'settings.mailIngest.port': '端口',
  'settings.mailIngest.username': '用户名',
  'settings.mailIngest.password': '密码（应用专用密码）',
  'settings.mailIngest.passwordHint': '请使用应用专用密码，而不是登录密码。',
  'settings.mailIngest.folder': '文件夹',
  'settings.mailIngest.folderHint': '默认 INBOX。指定专用文件夹可避免 TREK 读取其他邮件。',
  'settings.mailIngest.helpTitle': '在哪里创建应用专用密码？',
  'settings.mailIngest.helpBody': '大多数邮箱服务商会阻止普通 IMAP 登录 — 请生成应用专用密码，确认邮箱设置中已启用 IMAP，然后粘贴到上方。',
  'settings.mailIngest.testConnection': '测试连接',
  'settings.mailIngest.testing': '测试中…',
  'settings.mailIngest.connect': '连接邮箱',
  'settings.mailIngest.connecting': '连接中…',
  'settings.mailIngest.lastChecked': '上次检查 {time}',
  'settings.mailIngest.notCheckedYet': '尚未检查',
  'settings.mailIngest.catchUp': '补齐',
  'settings.mailIngest.catchUpHint': '立即扫描最近 30 天',
  'settings.mailIngest.remove': '移除',
  'settings.mailIngest.recentActivity': '最近活动',
  'settings.mailIngest.activityEmpty': '尚未处理任何邮件 — 运行补齐或等待下一次定时检查。',
  'settings.mailIngest.noSubject': '（无主题）',
  'settings.mailIngest.addedCount': '（已添加 {count} 项）',
  'settings.mailIngest.status.imported': '已导入',
  'settings.mailIngest.status.pending': '待处理',
  'settings.mailIngest.status.error': '错误',
  'settings.mailIngest.status.skipped': '已跳过',
  'settings.mailIngest.toast.testOk': '连接成功',
  'settings.mailIngest.toast.testFailed': '连接失败：{error}',
  'settings.mailIngest.toast.connected': '邮箱已连接',
  'settings.mailIngest.toast.caughtUp': '完成 — 已添加 {imported} 项，{pending} 项待确认，{skipped} 项已跳过',
