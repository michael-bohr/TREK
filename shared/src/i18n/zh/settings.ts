...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': '邮件导入：预订已导入',
  'settings.notifyMailIngestPending': '邮件导入：预订待审核',
  ...
  'settings.mailIngest.hint': '连接一个邮箱，TREK 会扫描其中的航班和酒店确认邮件，并自动归档到对应的行程。',
  'settings.mailIngest.host': 'IMAP 服务器',
  'settings.mailIngest.port': '端口',
  'settings.mailIngest.username': '邮箱地址',
  'settings.mailIngest.password': '密码',
  'settings.mailIngest.passwordHint': '大多数服务商要求使用应用专用密码而非常规密码 — 见下方说明。',
  'settings.mailIngest.folder': '文件夹',
  'settings.mailIngest.folderHint': '要扫描预订信息的 IMAP 文件夹（默认 INBOX）。',
  'settings.mailIngest.helpTitle': '在哪里获取应用专用密码？',
  'settings.mailIngest.helpBody': '大多数服务商会阻止普通的 IMAP 登录，需要生成并启用 IMAP 访问权限的应用专用密码。',
  'settings.mailIngest.testConnection': '测试连接',
  'settings.mailIngest.testing': '测试中…',
  'settings.mailIngest.connect': '连接',
  'settings.mailIngest.connecting': '连接中…',
  'settings.mailIngest.remove': '移除',
  'settings.mailIngest.catchUp': '补扫',
  'settings.mailIngest.catchUpHint': '扫描最近 30 天，查找 TREK 可能遗漏的预订。',
  'settings.mailIngest.lastChecked': '上次检查 {time}',
  'settings.mailIngest.notCheckedYet': '尚未检查',
  'settings.mailIngest.recentActivity': '最近活动',
  'settings.mailIngest.activityEmpty': '暂无活动。',
  'settings.mailIngest.noSubject': '（无主题）',
  'settings.mailIngest.addedCount': '已添加 {count} 项',
  'settings.mailIngest.status.imported': '已导入',
  'settings.mailIngest.status.pending': '待审核',
  'settings.mailIngest.status.error': '错误',
  'settings.mailIngest.status.skipped': '已跳过',
  'settings.mailIngest.toast.testOk': '连接成功',
  'settings.mailIngest.toast.testFailed': '测试失败：{error}',
  'settings.mailIngest.toast.connected': '邮箱已连接',
  'settings.mailIngest.toast.caughtUp': '补扫完成 — 已导入 {imported} 项，待审核 {pending} 项，已跳过 {skipped} 项',
