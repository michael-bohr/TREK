...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'Імпорт пошти: бронювання імпортовано',
  'settings.notifyMailIngestPending': 'Імпорт пошти: бронювання потребує перевірки',
  'settings.mailIngest.title': 'Імпорт пошти',
  'settings.mailIngest.hint':
    'Підключіть поштову скриньку, і TREK шукатиме в ній підтвердження рейсів і готелів, додаючи їх до відповідної подорожі (або створюючи нову). Читається ваша папка «Вхідні» — нижче можна вказати папку, наприклад окрему папку TREK.',
  'settings.mailIngest.host': 'IMAP-сервер',
  'settings.mailIngest.port': 'Порт',
  'settings.mailIngest.username': 'Ім\'я користувача',
  'settings.mailIngest.password': 'Пароль (пароль застосунку)',
  'settings.mailIngest.passwordHint': 'Використовуйте пароль застосунку, а не пароль для входу.',
  'settings.mailIngest.folder': 'Папка',
  'settings.mailIngest.folderHint': 'Типово INBOX. Вкажіть окрему папку, щоб TREK не бачив решту вашої пошти.',
  'settings.mailIngest.helpTitle': 'Де створити пароль застосунку?',
  'settings.mailIngest.helpBody':
    'Більшість провайдерів блокують звичайний вхід через IMAP — створіть пароль застосунку, переконайтеся, що IMAP увімкнено в налаштуваннях пошти, і вставте його вище.',
  'settings.mailIngest.testConnection': 'Перевірити з\'єднання',
  'settings.mailIngest.testing': 'Перевірка…',
  'settings.mailIngest.connect': 'Підключити скриньку',
  'settings.mailIngest.connecting': 'Підключення…',
  'settings.mailIngest.lastChecked': 'остання перевірка {time}',
  'settings.mailIngest.notCheckedYet': 'ще не перевірялося',
  'settings.mailIngest.catchUp': 'Наздогнати',
  'settings.mailIngest.catchUpHint': 'Просканувати останні 30 днів зараз',
  'settings.mailIngest.remove': 'Видалити',
  'settings.mailIngest.recentActivity': 'Нещодавня активність',
  'settings.mailIngest.activityEmpty':
    'Поки нічого не оброблено — запустіть наздоганяння або дочекайтеся наступної планової перевірки.',
  'settings.mailIngest.noSubject': '(без теми)',
  'settings.mailIngest.addedCount': '(додано: {count})',
  'settings.mailIngest.status.imported': 'імпортовано',
  'settings.mailIngest.status.pending': 'очікує',
  'settings.mailIngest.status.error': 'помилка',
  'settings.mailIngest.status.skipped': 'пропущено',
  'settings.mailIngest.toast.testOk': 'З\'єднання успішне',
  'settings.mailIngest.toast.testFailed': 'Помилка з\'єднання: {error}',
  'settings.mailIngest.toast.connected': 'Скриньку підключено',
  'settings.mailIngest.toast.caughtUp': 'Готово — додано: {imported}, на перевірку: {pending}, пропущено: {skipped}',
