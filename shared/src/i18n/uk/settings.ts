...
const settings: TranslationStrings = {
  ...
  'settings.mailIngest.hint':
    'Підключіть поштову скриньку, і TREK шукатиме в ній підтвердження рейсів і бронювання готелів, автоматично додаючи їх до потрібної поїздки.',
  'settings.mailIngest.host': 'IMAP-сервер',
  'settings.mailIngest.port': 'Порт',
  'settings.mailIngest.username': 'Адреса ел. пошти',
  'settings.mailIngest.password': 'Пароль',
  'settings.mailIngest.passwordHint':
    'Більшість провайдерів вимагають пароль застосунку замість звичайного пароля — див. нижче.',
  'settings.mailIngest.folder': 'Папка',
  'settings.mailIngest.folderHint': 'Папка IMAP для пошуку бронювань (типово INBOX).',
  'settings.mailIngest.helpTitle': 'Де взяти пароль застосунку?',
  'settings.mailIngest.helpBody':
    'Більшість провайдерів блокують звичайний вхід через IMAP і вимагають згенерований пароль застосунку з увімкненим доступом IMAP.',
  'settings.mailIngest.testConnection': "Перевірити з'єднання",
  'settings.mailIngest.testing': 'Перевірка…',
  'settings.mailIngest.connect': 'Підключити',
  'settings.mailIngest.connecting': 'Підключення…',
  'settings.mailIngest.remove': 'Видалити',
  'settings.mailIngest.catchUp': 'Наздогнати',
  'settings.mailIngest.catchUpHint': 'Перевіряє останні 30 днів на предмет бронювань, які TREK міг пропустити.',
  'settings.mailIngest.lastChecked': 'Востаннє перевірено {time}',
  'settings.mailIngest.notCheckedYet': 'Ще не перевірено',
  'settings.mailIngest.recentActivity': 'Остання активність',
  'settings.mailIngest.activityEmpty': 'Поки що немає активності.',
  ...
  'settings.mailIngest.status.pending': 'Потребує перевірки',
  ...
  'settings.mailIngest.toast.testFailed': 'Тест не пройдено: {error}',
  'settings.mailIngest.toast.connected': 'Поштову скриньку підключено',
  'settings.mailIngest.toast.caughtUp': 'Готово — імпортовано {imported}, на перевірці {pending}, пропущено {skipped}',
