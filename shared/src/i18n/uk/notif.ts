...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.title': 'Бронювання імпортовано',
  'notif.mail_ingest_imported.text': '«{subject}» додано до {trip}',
  'notif.mail_ingest_pending.title': 'Бронювання потребує перевірки',
  'notif.mail_ingest_pending.text': '«{subject}» не вдалося зіставити з подорожжю ({reason})',
