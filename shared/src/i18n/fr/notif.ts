...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.title': 'Réservation importée',
  'notif.mail_ingest_imported.text': '« {subject} » a été classée dans {trip}',
  'notif.mail_ingest_pending.title': 'Réservation à vérifier',
  'notif.mail_ingest_pending.text': '« {subject} » n\'a pas pu être associée à un voyage ({reason})',
