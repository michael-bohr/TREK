...
const settings: TranslationStrings = {
  ...
  'settings.mailIngest.hint':
    "Connectez une boîte mail et TREK y recherche les confirmations de vol et d'hôtel pour les classer automatiquement dans le bon voyage.",
  'settings.mailIngest.host': 'Serveur IMAP',
  'settings.mailIngest.port': 'Port',
  'settings.mailIngest.username': 'Adresse e-mail',
  'settings.mailIngest.password': 'Mot de passe',
  'settings.mailIngest.passwordHint':
    "La plupart des fournisseurs exigent un mot de passe d'application à la place de votre mot de passe habituel — voir ci-dessous.",
  'settings.mailIngest.folder': 'Dossier',
  'settings.mailIngest.folderHint': 'Dossier IMAP à analyser pour les réservations (INBOX par défaut).',
  'settings.mailIngest.helpTitle': "Où obtenir un mot de passe d'application ?",
  'settings.mailIngest.helpBody':
    "La plupart des fournisseurs bloquent les connexions IMAP classiques et exigent un mot de passe d'application généré avec l'accès IMAP activé.",
  'settings.mailIngest.testConnection': 'Tester la connexion',
  'settings.mailIngest.testing': 'Test en cours…',
  'settings.mailIngest.connect': 'Connecter',
  ...
  'settings.mailIngest.catchUpHint':
    'Analyse les 30 derniers jours à la recherche de réservations que TREK aurait pu manquer.',
  ...
  'settings.mailIngest.activityEmpty': 'Aucune activité pour le moment.',
  ...
  'settings.mailIngest.toast.testFailed': 'Échec du test : {error}',
  'settings.mailIngest.toast.connected': 'Boîte mail connectée',
  'settings.mailIngest.toast.caughtUp':
    'Rattrapage terminé — {imported} importé(s), {pending} à vérifier, {skipped} ignoré(s)',
