...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'Import d\'e-mails : réservation importée',
  'settings.notifyMailIngestPending': 'Import d\'e-mails : réservation à vérifier',
  'settings.mailIngest.title': 'Import d\'e-mails',
  'settings.mailIngest.hint':
    'Connectez une boîte mail et TREK y recherche les confirmations de vols et d\'hôtels pour les classer dans le bon voyage (créé au besoin). Votre boîte de réception est analysée — indiquez un dossier ci-dessous pour limiter la recherche, p. ex. à un dossier TREK dédié.',
  'settings.mailIngest.host': 'Hôte IMAP',
  'settings.mailIngest.port': 'Port',
  'settings.mailIngest.username': 'Nom d\'utilisateur',
  'settings.mailIngest.password': 'Mot de passe (mot de passe d\'application)',
  'settings.mailIngest.passwordHint': 'Utilisez un mot de passe d\'application, pas votre mot de passe de connexion.',
  'settings.mailIngest.folder': 'Dossier',
  'settings.mailIngest.folderHint':
    'INBOX par défaut. Choisissez un dossier dédié pour que TREK n\'accède pas au reste de vos e-mails.',
  'settings.mailIngest.helpTitle': 'Où créer un mot de passe d\'application ?',
  'settings.mailIngest.helpBody':
    'La plupart des fournisseurs bloquent les connexions IMAP simples — générez un mot de passe d\'application, vérifiez que l\'IMAP est activé dans vos réglages, puis collez-le ci-dessus.',
  'settings.mailIngest.testConnection': 'Tester la connexion',
  'settings.mailIngest.testing': 'Test…',
  'settings.mailIngest.connect': 'Connecter la boîte mail',
  'settings.mailIngest.connecting': 'Connexion…',
  'settings.mailIngest.lastChecked': 'dernière vérification {time}',
  'settings.mailIngest.notCheckedYet': 'pas encore vérifié',
  'settings.mailIngest.catchUp': 'Rattraper',
  'settings.mailIngest.catchUpHint': 'Analyser les 30 derniers jours maintenant',
  'settings.mailIngest.remove': 'Supprimer',
  'settings.mailIngest.recentActivity': 'Activité récente',
  'settings.mailIngest.activityEmpty':
    'Rien de traité pour l\'instant — lancez un rattrapage ou attendez la prochaine vérification planifiée.',
  'settings.mailIngest.noSubject': '(sans objet)',
  'settings.mailIngest.addedCount': '({count} ajouté(s))',
  'settings.mailIngest.status.imported': 'importé',
  'settings.mailIngest.status.pending': 'à vérifier',
  'settings.mailIngest.status.error': 'erreur',
  'settings.mailIngest.status.skipped': 'ignoré',
  'settings.mailIngest.toast.testOk': 'Connexion réussie',
  'settings.mailIngest.toast.testFailed': 'Échec de la connexion : {error}',
  'settings.mailIngest.toast.connected': 'Boîte mail connectée',
  'settings.mailIngest.toast.caughtUp':
    'Rattrapage terminé — {imported} ajouté(s), {pending} à vérifier, {skipped} ignoré(s)',
