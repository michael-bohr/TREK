...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'E-mailimport: boeking geïmporteerd',
  'settings.notifyMailIngestPending': 'E-mailimport: boeking heeft controle nodig',
  ...
  'settings.mailIngest.title': 'E-mailimport',
  'settings.mailIngest.hint':
    'Verbind een mailbox en TREK doorzoekt deze op vlucht- en hotelbevestigingen, die automatisch aan de juiste reis worden gekoppeld.',
  'settings.mailIngest.host': 'IMAP-server',
  'settings.mailIngest.port': 'Poort',
  'settings.mailIngest.username': 'E-mailadres',
  'settings.mailIngest.password': 'Wachtwoord',
  'settings.mailIngest.passwordHint':
    'De meeste providers vereisen een app-wachtwoord in plaats van je gewone wachtwoord — zie hieronder.',
  'settings.mailIngest.folder': 'Map',
  'settings.mailIngest.folderHint': 'IMAP-map om te doorzoeken voor boekingen (standaard INBOX).',
  'settings.mailIngest.helpTitle': 'Waar krijg ik een app-wachtwoord?',
  'settings.mailIngest.helpBody':
    'De meeste providers blokkeren gewone IMAP-logins en vereisen een gegenereerd app-wachtwoord met IMAP-toegang ingeschakeld.',
  'settings.mailIngest.testConnection': 'Verbinding testen',
  'settings.mailIngest.testing': 'Bezig met testen…',
  'settings.mailIngest.connect': 'Verbinden',
  'settings.mailIngest.connecting': 'Verbinden…',
  'settings.mailIngest.remove': 'Verwijderen',
  'settings.mailIngest.catchUp': 'Inhalen',
  'settings.mailIngest.catchUpHint': 'Doorzoekt de laatste 30 dagen op boekingen die TREK mogelijk heeft gemist.',
  ...
  'settings.mailIngest.activityEmpty': 'Nog geen activiteit.',
  ...
  'settings.mailIngest.status.pending': 'Controle nodig',
  ...
  'settings.mailIngest.toast.testFailed': 'Test mislukt: {error}',
  'settings.mailIngest.toast.connected': 'Mailbox verbonden',
  'settings.mailIngest.toast.caughtUp':
    'Ingehaald — {imported} geïmporteerd, {pending} te controleren, {skipped} overgeslagen',
