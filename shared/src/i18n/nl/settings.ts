...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'Mailimport: boeking geïmporteerd',
  'settings.notifyMailIngestPending': 'Mailimport: boeking ter controle',
  'settings.mailIngest.title': 'Mailimport',
  'settings.mailIngest.hint':
    'Koppel een mailbox en TREK doorzoekt deze op vlucht- en hotelbevestigingen en plaatst ze bij de juiste reis (of maakt die aan). Je inbox wordt gelezen om boekingen te vinden — stel hieronder een map in om dit te beperken, bijv. een aparte TREK-map.',
  'settings.mailIngest.host': 'IMAP-host',
  'settings.mailIngest.port': 'Poort',
  'settings.mailIngest.username': 'Gebruikersnaam',
  'settings.mailIngest.password': 'Wachtwoord (app-wachtwoord)',
  'settings.mailIngest.passwordHint': 'Gebruik een app-wachtwoord, niet je inlogwachtwoord.',
  'settings.mailIngest.folder': 'Map',
  'settings.mailIngest.folderHint': 'Standaard INBOX. Kies een aparte map zodat TREK niet bij de rest van je mail kan.',
  'settings.mailIngest.helpTitle': 'Waar maak ik een app-wachtwoord aan?',
  'settings.mailIngest.helpBody':
    'De meeste providers blokkeren gewone IMAP-logins — maak een app-wachtwoord aan, controleer of IMAP is ingeschakeld in je mailinstellingen en plak het hierboven.',
  'settings.mailIngest.testConnection': 'Verbinding testen',
  'settings.mailIngest.testing': 'Testen…',
  'settings.mailIngest.connect': 'Mailbox koppelen',
  'settings.mailIngest.connecting': 'Koppelen…',
  'settings.mailIngest.lastChecked': 'laatst gecontroleerd {time}',
  'settings.mailIngest.notCheckedYet': 'nog niet gecontroleerd',
  'settings.mailIngest.catchUp': 'Bijwerken',
  'settings.mailIngest.catchUpHint': 'Scan nu de afgelopen 30 dagen',
  'settings.mailIngest.remove': 'Verwijderen',
  'settings.mailIngest.recentActivity': 'Recente activiteit',
  'settings.mailIngest.activityEmpty':
    'Nog niets verwerkt — start een inhaalslag of wacht op de volgende geplande controle.',
  'settings.mailIngest.noSubject': '(geen onderwerp)',
  'settings.mailIngest.addedCount': '({count} toegevoegd)',
  'settings.mailIngest.status.imported': 'geïmporteerd',
  'settings.mailIngest.status.pending': 'in afwachting',
  'settings.mailIngest.status.error': 'fout',
  'settings.mailIngest.status.skipped': 'overgeslagen',
  'settings.mailIngest.toast.testOk': 'Verbinding geslaagd',
  'settings.mailIngest.toast.testFailed': 'Verbinding mislukt: {error}',
  'settings.mailIngest.toast.connected': 'Mailbox gekoppeld',
  'settings.mailIngest.toast.caughtUp':
    'Bijgewerkt — {imported} toegevoegd, {pending} ter controle, {skipped} overgeslagen',
