...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.title': 'Boeking geïmporteerd',
  'notif.mail_ingest_imported.text': '"{subject}" is opgeslagen bij {trip}',
  'notif.mail_ingest_pending.title': 'Boeking heeft controle nodig',
  'notif.mail_ingest_pending.text': '"{subject}" kon niet aan een reis worden gekoppeld ({reason})',
