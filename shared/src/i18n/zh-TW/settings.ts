...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': '郵件匯入：已匯入預訂',
  'settings.notifyMailIngestPending': '郵件匯入：待確認的預訂',
  'settings.mailIngest.title': '郵件匯入',
  'settings.mailIngest.hint':
    '連接信箱後，TREK 會掃描其中的機票與飯店確認信，並將其歸入對應的行程（如無則自動建立）。TREK 會讀取你的收件匣來尋找預訂 — 可在下方指定資料夾以限制範圍，例如專用的 TREK 資料夾。',
  'settings.mailIngest.host': 'IMAP 伺服器',
  'settings.mailIngest.port': '連接埠',
  'settings.mailIngest.username': '使用者名稱',
  'settings.mailIngest.password': '密碼（應用程式密碼）',
  'settings.mailIngest.passwordHint': '請使用應用程式密碼，而非登入密碼。',
  'settings.mailIngest.folder': '資料夾',
  'settings.mailIngest.folderHint': '預設 INBOX。指定專用資料夾可避免 TREK 讀取其他郵件。',
  'settings.mailIngest.helpTitle': '要在哪裡建立應用程式密碼？',
  'settings.mailIngest.helpBody': '大多數信箱服務商會封鎖一般 IMAP 登入 — 請產生應用程式密碼，確認信箱設定已啟用 IMAP，然後貼到上方。',
  'settings.mailIngest.testConnection': '測試連線',
  'settings.mailIngest.testing': '測試中…',
  'settings.mailIngest.connect': '連接信箱',
  'settings.mailIngest.connecting': '連線中…',
  'settings.mailIngest.lastChecked': '上次檢查 {time}',
  'settings.mailIngest.notCheckedYet': '尚未檢查',
  'settings.mailIngest.catchUp': '補齊',
  'settings.mailIngest.catchUpHint': '立即掃描最近 30 天',
  'settings.mailIngest.remove': '移除',
  'settings.mailIngest.recentActivity': '最近活動',
  'settings.mailIngest.activityEmpty': '尚未處理任何郵件 — 執行補齊或等待下一次排程檢查。',
  'settings.mailIngest.noSubject': '（無主旨）',
  'settings.mailIngest.addedCount': '（已新增 {count} 項）',
  'settings.mailIngest.status.imported': '已匯入',
  'settings.mailIngest.status.pending': '待處理',
  'settings.mailIngest.status.error': '錯誤',
  'settings.mailIngest.status.skipped': '已略過',
  'settings.mailIngest.toast.testOk': '連線成功',
  'settings.mailIngest.toast.testFailed': '連線失敗：{error}',
  'settings.mailIngest.toast.connected': '信箱已連接',
  'settings.mailIngest.toast.caughtUp': '完成 — 已新增 {imported} 項，{pending} 項待確認，{skipped} 項已略過',
