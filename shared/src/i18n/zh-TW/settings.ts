...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': '郵件匯入:預訂已匯入',
  'settings.notifyMailIngestPending': '郵件匯入:預訂待審查',
  ...
  'settings.mailIngest.hint': '連接一個信箱,TREK 會掃描其中的航班與飯店確認信,並自動歸檔到對應的行程。',
  'settings.mailIngest.host': 'IMAP 伺服器',
  'settings.mailIngest.port': '連接埠',
  'settings.mailIngest.username': '電子郵件地址',
  'settings.mailIngest.password': '密碼',
  'settings.mailIngest.passwordHint': '大多數服務商需要應用程式密碼而非一般密碼 — 見下方說明。',
  'settings.mailIngest.folder': '資料夾',
  'settings.mailIngest.folderHint': '要掃描預訂資訊的 IMAP 資料夾(預設 INBOX)。',
  'settings.mailIngest.helpTitle': '哪裡可以取得應用程式密碼?',
  'settings.mailIngest.helpBody': '大多數服務商會封鎖一般 IMAP 登入,需要產生並啟用 IMAP 存取權限的應用程式密碼。',
  'settings.mailIngest.testConnection': '測試連線',
  'settings.mailIngest.testing': '測試中…',
  'settings.mailIngest.connect': '連接',
  'settings.mailIngest.connecting': '連接中…',
  'settings.mailIngest.remove': '移除',
  'settings.mailIngest.catchUp': '補掃',
  'settings.mailIngest.catchUpHint': '掃描最近 30 天,尋找 TREK 可能遺漏的預訂。',
  'settings.mailIngest.lastChecked': '上次檢查 {time}',
  'settings.mailIngest.notCheckedYet': '尚未檢查',
  'settings.mailIngest.recentActivity': '最近活動',
  'settings.mailIngest.activityEmpty': '尚無活動。',
  'settings.mailIngest.noSubject': '(無主旨)',
  'settings.mailIngest.addedCount': '已新增 {count} 筆',
  'settings.mailIngest.status.imported': '已匯入',
  'settings.mailIngest.status.pending': '待審查',
  'settings.mailIngest.status.error': '錯誤',
  'settings.mailIngest.status.skipped': '已略過',
  'settings.mailIngest.toast.testOk': '連線成功',
  'settings.mailIngest.toast.testFailed': '測試失敗:{error}',
  'settings.mailIngest.toast.connected': '信箱已連接',
  'settings.mailIngest.toast.caughtUp': '補掃完成 — 已匯入 {imported} 筆,待審查 {pending} 筆,已略過 {skipped} 筆',
