...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.title': '已匯入預訂',
  'notif.mail_ingest_imported.text': '「{subject}」已歸入 {trip}',
  'notif.mail_ingest_pending.title': '待確認的預訂',
  'notif.mail_ingest_pending.text': '「{subject}」無法對應任何行程（{reason}）',
