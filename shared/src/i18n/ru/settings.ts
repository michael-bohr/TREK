...
const settings: TranslationStrings = {
  ...
  'settings.mailIngest.hint':
    'Подключите почтовый ящик, и TREK будет искать в нём подтверждения рейсов и бронирования отелей, автоматически прикрепляя их к нужной поездке.',
  'settings.mailIngest.host': 'IMAP-сервер',
  'settings.mailIngest.port': 'Порт',
  'settings.mailIngest.username': 'Адрес эл. почты',
  'settings.mailIngest.password': 'Пароль',
  'settings.mailIngest.passwordHint':
    'Большинство провайдеров требуют пароль приложения вместо обычного пароля — см. ниже.',
  'settings.mailIngest.folder': 'Папка',
  'settings.mailIngest.folderHint': 'Папка IMAP для проверки бронирований (по умолчанию INBOX).',
  'settings.mailIngest.helpTitle': 'Где взять пароль приложения?',
  'settings.mailIngest.helpBody':
    'Большинство провайдеров блокируют обычный вход по IMAP и требуют сгенерированный пароль приложения с включённым доступом IMAP.',
  'settings.mailIngest.testConnection': 'Проверить соединение',
  'settings.mailIngest.testing': 'Проверка…',
  'settings.mailIngest.connect': 'Подключить',
  'settings.mailIngest.connecting': 'Подключение…',
  'settings.mailIngest.remove': 'Удалить',
  'settings.mailIngest.catchUp': 'Досканировать',
  'settings.mailIngest.catchUpHint':
    'Проверяет последние 30 дней на предмет бронирований, которые TREK мог пропустить.',
  'settings.mailIngest.lastChecked': 'Последняя проверка {time}',
  'settings.mailIngest.notCheckedYet': 'Ещё не проверено',
  'settings.mailIngest.recentActivity': 'Последняя активность',
  'settings.mailIngest.activityEmpty': 'Активности пока нет.',
  ...
  'settings.mailIngest.status.pending': 'Требует проверки',
  'settings.mailIngest.status.error': 'Ошибка',
  'settings.mailIngest.status.skipped': 'Пропущено',
  'settings.mailIngest.toast.testOk': 'Соединение установлено',
  'settings.mailIngest.toast.testFailed': 'Тест не пройден: {error}',
  'settings.mailIngest.toast.connected': 'Почтовый ящик подключён',
  'settings.mailIngest.toast.caughtUp': 'Готово — импортировано {imported}, на проверке {pending}, пропущено {skipped}',
