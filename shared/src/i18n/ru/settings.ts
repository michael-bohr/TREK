...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'Импорт почты: бронирование импортировано',
  'settings.notifyMailIngestPending': 'Импорт почты: бронирование требует проверки',
  'settings.mailIngest.title': 'Импорт почты',
  'settings.mailIngest.hint':
    'Подключите почтовый ящик, и TREK будет искать в нём подтверждения рейсов и отелей, добавляя их в подходящую поездку (или создавая новую). Читается ваша папка «Входящие» — ниже можно указать папку, например, отдельную папку TREK.',
  'settings.mailIngest.host': 'IMAP-сервер',
  'settings.mailIngest.port': 'Порт',
  'settings.mailIngest.username': 'Имя пользователя',
  'settings.mailIngest.password': 'Пароль (пароль приложения)',
  'settings.mailIngest.passwordHint': 'Используйте пароль приложения, а не пароль для входа.',
  'settings.mailIngest.folder': 'Папка',
  'settings.mailIngest.folderHint': 'По умолчанию INBOX. Укажите отдельную папку, чтобы TREK не видел остальную почту.',
  'settings.mailIngest.helpTitle': 'Где создать пароль приложения?',
  'settings.mailIngest.helpBody':
    'Большинство провайдеров блокируют обычный вход по IMAP — создайте пароль приложения, убедитесь, что IMAP включён в настройках почты, и вставьте его выше.',
  'settings.mailIngest.testConnection': 'Проверить подключение',
  'settings.mailIngest.testing': 'Проверка…',
  'settings.mailIngest.connect': 'Подключить ящик',
  'settings.mailIngest.connecting': 'Подключение…',
  'settings.mailIngest.lastChecked': 'последняя проверка {time}',
  'settings.mailIngest.notCheckedYet': 'ещё не проверялось',
  'settings.mailIngest.catchUp': 'Догнать',
  'settings.mailIngest.catchUpHint': 'Просканировать последние 30 дней сейчас',
  'settings.mailIngest.remove': 'Удалить',
  'settings.mailIngest.recentActivity': 'Недавняя активность',
  'settings.mailIngest.activityEmpty':
    'Пока ничего не обработано — запустите догон или дождитесь следующей плановой проверки.',
  'settings.mailIngest.noSubject': '(без темы)',
  'settings.mailIngest.addedCount': '(добавлено: {count})',
  'settings.mailIngest.status.imported': 'импортировано',
  'settings.mailIngest.status.pending': 'ожидает',
  'settings.mailIngest.status.error': 'ошибка',
  'settings.mailIngest.status.skipped': 'пропущено',
  'settings.mailIngest.toast.testOk': 'Подключение успешно',
  'settings.mailIngest.toast.testFailed': 'Ошибка подключения: {error}',
  'settings.mailIngest.toast.connected': 'Ящик подключён',
  'settings.mailIngest.toast.caughtUp': 'Готово — добавлено: {imported}, на проверку: {pending}, пропущено: {skipped}',
