...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.title': 'Бронирование импортировано',
  'notif.mail_ingest_imported.text': '«{subject}» добавлено в {trip}',
  'notif.mail_ingest_pending.title': 'Бронирование требует проверки',
  'notif.mail_ingest_pending.text': '«{subject}» не удалось сопоставить с поездкой ({reason})',
