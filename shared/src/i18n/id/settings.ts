...
const settings: TranslationStrings = {
  ...
  'settings.mailIngest.hint':
    'Hubungkan kotak surat dan TREK akan memindainya untuk konfirmasi penerbangan dan hotel, lalu mengarsipkannya secara otomatis ke perjalanan yang tepat.',
  'settings.mailIngest.host': 'Server IMAP',
  'settings.mailIngest.port': 'Port',
  'settings.mailIngest.username': 'Alamat email',
  'settings.mailIngest.password': 'Kata sandi',
  'settings.mailIngest.passwordHint':
    'Sebagian besar penyedia mengharuskan kata sandi aplikasi, bukan kata sandi biasa Anda — lihat di bawah.',
  'settings.mailIngest.folder': 'Folder',
  'settings.mailIngest.folderHint': 'Folder IMAP yang dipindai untuk pemesanan (default INBOX).',
  'settings.mailIngest.helpTitle': 'Di mana saya mendapatkan kata sandi aplikasi?',
  'settings.mailIngest.helpBody':
    'Sebagian besar penyedia memblokir login IMAP biasa dan mengharuskan kata sandi aplikasi yang dibuat dengan akses IMAP diaktifkan.',
  'settings.mailIngest.testConnection': 'Uji koneksi',
  'settings.mailIngest.testing': 'Menguji…',
  'settings.mailIngest.connect': 'Hubungkan',
  'settings.mailIngest.connecting': 'Menghubungkan…',
  'settings.mailIngest.remove': 'Hapus',
  'settings.mailIngest.catchUp': 'Pindai ulang',
  'settings.mailIngest.catchUpHint': 'Memindai 30 hari terakhir untuk pemesanan yang mungkin terlewat oleh TREK.',
  ...
  'settings.mailIngest.activityEmpty': 'Belum ada aktivitas.',
  ...
  'settings.mailIngest.status.pending': 'Perlu ditinjau',
  ...
  'settings.mailIngest.toast.testFailed': 'Pengujian gagal: {error}',
  'settings.mailIngest.toast.connected': 'Kotak surat terhubung',
  'settings.mailIngest.toast.caughtUp': 'Selesai — {imported} diimpor, {pending} ditinjau, {skipped} dilewati',
