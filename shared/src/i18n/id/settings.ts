...
const settings: TranslationStrings = {
  ...
  'settings.notifyMailIngestImported': 'Impor email: pemesanan diimpor',
  'settings.notifyMailIngestPending': 'Impor email: pemesanan perlu ditinjau',
  'settings.mailIngest.title': 'Impor email',
  'settings.mailIngest.hint':
    'Hubungkan kotak surat dan TREK memindainya untuk konfirmasi penerbangan & hotel, lalu memasukkannya ke perjalanan yang sesuai (membuatnya jika belum ada). TREK membaca kotak masuk Anda — tentukan folder di bawah untuk membatasinya, mis. folder TREK khusus.',
  'settings.mailIngest.host': 'Host IMAP',
  'settings.mailIngest.port': 'Port',
  'settings.mailIngest.username': 'Nama pengguna',
  'settings.mailIngest.password': 'Kata sandi (kata sandi aplikasi)',
  'settings.mailIngest.passwordHint': 'Gunakan kata sandi aplikasi, bukan kata sandi login Anda.',
  'settings.mailIngest.folder': 'Folder',
  'settings.mailIngest.folderHint':
    'Bawaan INBOX. Arahkan ke folder khusus agar TREK tidak membaca email Anda yang lain.',
  'settings.mailIngest.helpTitle': 'Di mana saya membuat kata sandi aplikasi?',
  'settings.mailIngest.helpBody':
    'Sebagian besar penyedia memblokir login IMAP biasa — buat kata sandi aplikasi, pastikan IMAP aktif di pengaturan email Anda, lalu tempel di atas.',
  'settings.mailIngest.testConnection': 'Uji koneksi',
  'settings.mailIngest.testing': 'Menguji…',
  'settings.mailIngest.connect': 'Hubungkan kotak surat',
  'settings.mailIngest.connecting': 'Menghubungkan…',
  'settings.mailIngest.lastChecked': 'terakhir diperiksa {time}',
  'settings.mailIngest.notCheckedYet': 'belum diperiksa',
  'settings.mailIngest.catchUp': 'Susul',
  'settings.mailIngest.catchUpHint': 'Pindai 30 hari terakhir sekarang',
  'settings.mailIngest.remove': 'Hapus',
  'settings.mailIngest.recentActivity': 'Aktivitas terbaru',
  'settings.mailIngest.activityEmpty':
    'Belum ada yang diproses — jalankan susulan atau tunggu pemeriksaan terjadwal berikutnya.',
  'settings.mailIngest.noSubject': '(tanpa subjek)',
  'settings.mailIngest.addedCount': '({count} ditambahkan)',
  'settings.mailIngest.status.imported': 'diimpor',
  'settings.mailIngest.status.pending': 'tertunda',
  'settings.mailIngest.status.error': 'kesalahan',
  'settings.mailIngest.status.skipped': 'dilewati',
  'settings.mailIngest.toast.testOk': 'Koneksi berhasil',
  'settings.mailIngest.toast.testFailed': 'Koneksi gagal: {error}',
  'settings.mailIngest.toast.connected': 'Kotak surat terhubung',
  'settings.mailIngest.toast.caughtUp':
    'Selesai — {imported} ditambahkan, {pending} perlu ditinjau, {skipped} dilewati',
