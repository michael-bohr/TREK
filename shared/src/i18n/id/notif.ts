...
const notif: TranslationStrings = {
  ...
  'notif.mail_ingest_imported.title': 'Pemesanan diimpor',
  'notif.mail_ingest_imported.text': '"{subject}" diarsipkan ke {trip}',
  'notif.mail_ingest_pending.title': 'Pemesanan perlu ditinjau',
  'notif.mail_ingest_pending.text': '"{subject}" tidak dapat dicocokkan dengan perjalanan mana pun ({reason})',
